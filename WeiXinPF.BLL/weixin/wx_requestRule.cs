...
namespace WeiXinPF.BLL
{
    ...
    {
        private readonly WeiXinPF.DAL.wx_requestRule dal = new WeiXinPF.DAL.wx_requestRule();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WeiXinPF.Model.wx_requestRule model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WeiXinPF.Model.wx_requestRule model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_requestRule GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_requestRule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_requestRule> DataTableToList(DataTable dt)
        {
            List<WeiXinPF.Model.wx_requestRule> modelList = new List<WeiXinPF.Model.wx_requestRule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WeiXinPF.Model.wx_requestRule model;

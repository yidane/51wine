...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_userweixin dal=new WeiXinPF.DAL.wx_userweixin();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_userweixin model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_userweixin model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_userweixin GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_userweixin> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_userweixin> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_userweixin> modelList = new List<WeiXinPF.Model.wx_userweixin>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_userweixin model;

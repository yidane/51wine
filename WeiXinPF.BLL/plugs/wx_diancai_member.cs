...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_diancai_member dal=new WeiXinPF.DAL.wx_diancai_member();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_diancai_member model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_diancai_member model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_member GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_diancai_member> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_diancai_member> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_diancai_member> modelList = new List<WeiXinPF.Model.wx_diancai_member>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_diancai_member model;
        ...
        {
            return dal.Update(openid);
        }
        public bool Updatefail(string openid)
        {
            return dal.Updatefail(openid);
        }


        /// <summary>
        /// 通过shopid和openid获得该用户的详细基本信息
        /// </summary>
        public WeiXinPF.Model.wx_diancai_member GetModel(int shopid, string openid)
        {

            return dal.GetModel(shopid, openid);
        }

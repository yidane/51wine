...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_shop_cart dal=new WeiXinPF.DAL.wx_shop_cart();
		public wx_shop_cart()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_shop_cart model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_shop_cart model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_shop_cart GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_shop_cart> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_shop_cart> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_shop_cart> modelList = new List<WeiXinPF.Model.wx_shop_cart>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_shop_cart model;

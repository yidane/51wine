...
FCAPP.REVIEW = FCAPP.REVIEW || {
    ...
    sendReview: function () {
        ...
        if (isNaN(id) || review.length != 4) {
            ...
            var fid = $('#fid').val();
            $.getJSON('cldata.ashx?myact=fyyx', { 'wid': wid, 'openid': openid, 'fid': fid, 'imp_user': imp_user }, function (data) {
                ...
                if (data.errno == '1') {
                    ...
                    if (data.res == '1') {
                        ...
                        $('#userReview').html('<div class="is_review">我的楼盘印象<i>“' + imp_user + '”</i>与' + data.res
                             + '房友相同</div>');
                    }

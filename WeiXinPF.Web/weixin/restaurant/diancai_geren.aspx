<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="diancai_geren.aspx.cs" Inherits="WeiXinPF.Web.weixin.restaurant.diancai_geren" %>
...
<body class="mode_webapp">
                    ...
                    <table style="padding: 0; margin: 0; width: 100%;">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="ui-input-text">
                                        <input type="text" id="wxname" name="wxname" value="" placeholder="" class="ui-input-text"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="ui-input-text">
                                        <input type="text" id="username" name="username" value="<%=username %>" placeholder="" class="ui-input-text"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="ui-input-text">
                                        <input type="tel" id="phone" name="phone" value="<%=usertel %>" placeholder="" class="ui-input-text"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="address" name="address" placeholder=""  class="ui-input-text"><%=useraddr %></textarea>
                                </td>
                            </tr>
    ...
    <div class="footermenu">
        <ul>
            ...
            <li>
                <a class="active" href="diancai_geren.aspx?shopid=<%=shopid %>&openid=<%=openid %>">

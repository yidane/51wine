<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeiXinPF.Web.weixin.restaurant.index" %>
<html>
<head runat="server">
...
<body class="mode_webapp">
    ...
    <div class="footermenu">
        <ul>
            ...
            <li>
                <a class="active" href="index.aspx?shopid=<%=shopid %>&openid=<%=openid %>">
    ...
    <script>
        ...
        OAK.Shop.Cart.prototype = {
           ...
           addProduct: function (p, conditions) {
               ...
               var ret_num = 0;
               //一元鸭翅活动
               if (p.name == "=========" && this.existProduct({ name: p.name })) {
                  // alert("每单只能购买一盒一元鸭翅");
                   return;
               }

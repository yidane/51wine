<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="WeiXinPF.Web.admin.article.article_list" %>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#new WeiXinPF.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
                    <td>
                        <%# Eval("link_url") %>
                    </td>

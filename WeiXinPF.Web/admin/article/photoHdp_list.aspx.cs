...
{
    public partial class photoHdp_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // this.prolistview = Utils.GetCookie("photoHdp_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
        ...
        private void RptBind(int _channel_id, int _category_id, string _strWhere, string _orderby)
        {
            ...
            this.rptList2.DataSource = bll.GetWCodeList(weixin.id, _channel_id, _category_id, this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
            this.rptList2.DataBind();

            //绑定页码
            txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = Utils.CombUrlTxt("photoHdp_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("photoHdp_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", Utils.CombUrlTxt("photoHdp_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",

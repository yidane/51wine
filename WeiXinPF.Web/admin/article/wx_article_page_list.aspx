<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_article_page_list.aspx.cs" Inherits="WeiXinPF.Web.admin.article.wx_article_page_list" %>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><a href="wx_article_page_edit.aspx?action=<%#MXEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
                    <td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="WeiXinPF.Web.admin.order.order_edit" ValidateRequest="false" %>
                ...
                <dd>
                    <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                        ...
                        <tr>
                            <th>购物折扣</th>
                            <td>
                                <asp:Label ID="lbUserDiscount" runat="server" Text="100" />
                                %</td>
                        </tr>
                        <tr>
                            <th>账户余额</th>
            ...
            <dl>
                ...
                <dd>
                    <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                        <tr>
                            <th width="20%">支付方式</th>
                            <td><%=new WeiXinPF.BLL.payment().GetTitle(model.wid.Value,model.payment_id) %></td>
                        </tr>
                        <tr>
                            <th>配送方式</th>
                            <td><%=new WeiXinPF.BLL.express().GetTitle(model.express_id) %></td>
                        </tr>
                        <tr>
                            <th>用户留言</th>
                            <td><%=model.message %></td>

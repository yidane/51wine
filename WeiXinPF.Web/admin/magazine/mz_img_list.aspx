<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mz_img_list.aspx.cs" Inherits="WeiXinPF.Web.admin.magazine.mz_img_list" %>
    ...
    <script type="text/javascript">
        ...
        function selectico(iid) {
            $.dialog({
                ...
                min: false,
                title: "动画编辑",
                content: "url:/admin/magazine/animate.aspx?iid=" + iid,
                height: 620,
                width: 760
            });
        }
            ...
            <ItemTemplate>
                <li>
                    <div class="details<%#Eval("url").ToString() != "" ? "" : " nopic"%>">
                        ...
                        <div class="tools">
                            <span class="animate" onclick="selectico(<%#Eval("id") %>)">设置动画</span>

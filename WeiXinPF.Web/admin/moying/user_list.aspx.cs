...
namespace WeiXinPF.Web.admin.moying
{
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        BLL.wx_my_user xbll = new BLL.wx_my_user();
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            litwUrl.Text = MyCommFun.getWebSite() + "/weixin/muying/my_search.aspx?wid=" + weixin.id;
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and  ( username like  '%" + _keywords + "%'  or usertel like  '%" + _keywords + "%' or useraddr like  '%" + _keywords + "%')");
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除体检用户信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志

            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("user_list.aspx", "keywords={0}", this.keywords), "Success");
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_base_add.aspx.cs" Inherits="WeiXinPF.Web.admin.grouppurchase.group_base_add" %>
    ...
    <form id="form1" runat="server">
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">团购活动结束内容</a></li>
                        <li><a href="javascript:;" onclick="tabs(this);">商家信息设置</a></li>
                        <li><a href="javascript:;" onclick="tabs(this);">团购设置</a></li>
        ...
        <div class="tab-content">
            ...
            <dl style="display:none;">
                <dt>通知邮箱：</dt>
                <dd>
                    <asp:TextBox runat="server" ID="email" CssClass="input normal" datatype="*0-100" sucmsg=" " nullmsg=""></asp:TextBox>
                    <span class="Validform_checktip">*</span>
                    <br />

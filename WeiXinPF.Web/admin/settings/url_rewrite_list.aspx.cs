...
namespace WeiXinPF.Web.admin.settings
{
    public partial class url_rewrite_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel = MXRequest.GetQueryString("channel");
            this.type = MXRequest.GetQueryString("type");
        ...
        {
            ChkAdminLevel("site_url_rewrite", MXEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除URL配置信息"); //记录日志

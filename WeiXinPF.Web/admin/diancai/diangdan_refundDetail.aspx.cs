...
namespace WeiXinPF.Web.admin.diancai
{
    public partial class diangdan_refundDetail : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            orderID = MyCommFun.RequestInt("orderId");
        ...
        public void List()
        {
            ...
            DataSet dr = new wx_diancai_tuidan_manage().GetRefundDetailWithOrderDetail(shopid, orderID, refundCode);
            ...
            //manage = managebll.GetModeldingdan(1);
            ////退单信息
            //if (manage != null)
            //{

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caipin_category_add.aspx.cs" Inherits="WeiXinPF.Web.admin.diancai.caipin_category_add" %>
           ...
           <% if (IsWeiXinCode())
            ...
            <a    href="shop_list.aspx" class="home"><i></i><span>商户或门店列表</span></a>
              <i class="arrow"></i>
                ...
                <%} %> <span> <a href="caipin_category.aspx?shopid=<%=shopid %>" >商品分类管理</a></span>
            <i class="arrow"></i>

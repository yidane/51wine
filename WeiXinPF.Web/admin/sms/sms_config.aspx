<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms_config.aspx.cs" Inherits="WeiXinPF.Web.admin.sms.sms_config" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>签名</dt>
                <dd>
                    <asp:TextBox ID="txtqianming" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" " Text="" nullmsg="签名格式如【沐雪网络科技】" />
                    <span class="Validform_checktip">*签名格式如【沐雪网络科技】</span>
                </dd>
            </dl>

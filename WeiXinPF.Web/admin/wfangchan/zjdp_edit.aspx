<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zjdp_edit.aspx.cs" Inherits="WeiXinPF.Web.admin.wfangchan.zjdp_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>显示顺序:</dt>
                <dd>
                    <asp:TextBox ID="txtSort_id" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" " Text="99" />

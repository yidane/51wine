<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paypage.aspx.cs" Inherits="WeiXinPF.Web.api.payment.paypage" %>
...
<body>
    <section class="body">
        ...
        <a href="javascript:void(0);" class="btn" id="reload" onclick="javascript:location.href='<%=rpage %>'">刷新</a>
    </section>

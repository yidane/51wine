    ...
    public class shopmgr : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else if (_action == "order_save")
            {
                ...
                {
                    gls.Add(new Model.order_goods { goods_id = item.productId, goods_title = item.productName, goods_price = item.avgPrice, real_price = item.avgPrice, quantity = item.productNum, point = 0 });
                }

    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            LogManager.Debug("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogManager.Debug("WxPayApi", "MicroPay response : " + response);
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogManager.Debug("WxPayApi", "OrderQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
            LogManager.Debug("WxPayApi", "OrderQuery response : " + response);
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogManager.Debug("WxPayApi", "Reverse request : " + xml);

            string response = HttpService.Post(xml, url, true, timeOut);

            LogManager.Debug("WxPayApi", "Reverse response : " + response);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogManager.Debug("WxPayApi", "Refund request : " + xml);
            string response = HttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
            LogManager.Debug("WxPayApi", "Refund response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogManager.Debug("WxPayApi", "DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogManager.Debug("WxPayApi", "DownloadBill result : " + response);
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogManager.Debug("WxPayApi", "ShortUrl request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            LogManager.Debug("WxPayApi", "ShortUrl response : " + response);
        ...
        */
        public static UnifiedOrderResult UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            var result = new UnifiedOrderResult(response);
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            LogManager.Info("WxPayApi", "Report request : " + xml);

            var response = HttpService.Post(xml, url, false, timeOut);

            LogManager.Info("WxPayApi", "Report response : " + response);

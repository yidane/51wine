...
namespace OneGulp.WeChat.MessageHandlers
{
    /// <summary>
    /// 微信请求的集中处理方法
    /// 此方法中所有过程，都基于OneGulp.WeChat的基础功能，只为简化代码而设。
    /// </summary>
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        ///// 上下文
        ///// </summary>
        //public static WeChatContext<TC> GlobalWeChatContext = new WeChatContext<TC>();

        /// <summary>
        /// 全局消息上下文
        /// </summary>
        public abstract WeChatContext<TC, TRequest, TResponse> WeChatContext { get; }
        ...
        {
            get { return WeChatContext.GetMessageContext(RequestMessage); }
        }
        ...
        /// 
        /// </summary>
        [Obsolete("UserName属性从v0.6起已过期，建议使用WeChatOpenId")]
        ...
        /// 如果是OneGulp.WeChat.QY，则应当和ResponseDocument一致；如果是OneGulp.WeChat.QY，则应当在ResponseDocument基础上进行加密
        /// </summary>
        ...
        public MessageHandler(RequestMessageBase requestMessageBase, int maxRecordCount = 0, object postData = null)
        {
            ...
            //此方法不执行任何方法，提供给具体的类库进行测试使用，例如OneGulp.WeChat.QY
        }

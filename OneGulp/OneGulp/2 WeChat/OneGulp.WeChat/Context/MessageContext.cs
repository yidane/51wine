...
namespace OneGulp.WeChat.Context
{
    /// <summary>
    /// 微信消息上下文（单个用户）接口
    /// </summary>
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        event EventHandler<WeChatContextRemovedEventArgs<TRequest, TResponse>> MessageContextRemoved;
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        /// </summary>
        public virtual event EventHandler<WeChatContextRemovedEventArgs<TRequest, TResponse>> MessageContextRemoved = null;
        ...
        /// </summary>
        /// <param name="e"></param>
        private void OnMessageContextRemoved(WeChatContextRemovedEventArgs<TRequest, TResponse> e)
        {
            EventHandler<WeChatContextRemovedEventArgs<TRequest, TResponse>> temp = MessageContextRemoved;
        ...
        {
            var onRemovedArg = new WeChatContextRemovedEventArgs<TRequest, TResponse>(this);

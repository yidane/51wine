...
{
    public static class WeChatContextGlobal
    {
        ...
        /// 是否开启上下文记录
        /// </summary>
        public static bool UseWeChatContext = true;

    }

    #region 废除接口
    //public interface IWeChatContext<TM, TRequest, TResponse>
    ...
    /// 默认过期时间：90分钟
    /// </summary>
    public class WeChatContext<TM, TRequest, TResponse> /*: IWeChatContext<TM, TRequest, TResponse>*/

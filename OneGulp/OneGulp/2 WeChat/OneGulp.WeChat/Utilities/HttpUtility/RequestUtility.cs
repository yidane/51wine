...
namespace OneGulp.WeChat.HttpUtility
{
    public static class RequestUtility
    {
        ...
        /// <param name="url"></param>
        /// <returns></returns>
        public static string HttpNewGet(string url, Encoding encoding = null)
        {
        ...
        /// <returns></returns>
        public static bool IsWeChatClientRequest(this HttpContext httpContext)
        {

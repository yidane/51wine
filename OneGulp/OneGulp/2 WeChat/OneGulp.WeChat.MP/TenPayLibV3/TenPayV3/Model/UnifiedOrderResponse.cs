...
namespace Travel.Infrastructure.WeiXin.Advanced.Pay.Model
{
    public class UnifiedOrderResponse
    {
        ...
        public bool IsSuccess
        {
            get
            {
                return string.Equals(this.return_code, "SUCCESS");
            }
        }
        ...
        public UnifiedOrderResponse(XmlDocument xmlDocument)
        {
            Init(xmlDocument);
        }
        ...
        public UnifiedOrderResponse(string xmlDocumentString)
        {
        ...
        public JsAPIParameter GetJsApiParameters(string key)
        {
            ...
            var noncsStr = TenPayV3Util.GetNoncestr();
            var packageStr = "prepay_id=" + this.prepay_id;

            sortDictionary.Add("appId", this.appid);
            sortDictionary.Add("timeStamp", timeStamp);
            sortDictionary.Add("nonceStr", noncsStr);
            sortDictionary.Add("package", "prepay_id=" + this.prepay_id);
            sortDictionary.Add("signType", "MD5");
            ...
            sortDictionary.Add("paySign", TenPayV3Util.MakeSign(str));

            return new JsAPIParameter()
                {
                    appId = sortDictionary["appId"],
                    timeStamp = sortDictionary["timeStamp"],
                    nonceStr = sortDictionary["nonceStr"],
                    package = sortDictionary["package"],
                    paySign = sortDictionary["paySign"]
                };
        }
    }

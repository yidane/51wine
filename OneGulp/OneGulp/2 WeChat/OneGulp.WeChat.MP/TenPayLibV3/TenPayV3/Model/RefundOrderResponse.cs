...
namespace Travel.Infrastructure.WeiXin.Advanced.Pay.Model
{
    public class RefundOrderResponse
    {
        ...
        public bool IsSuccess
        {
            get
            {
                return string.Equals(return_code, "SUCCESS", StringComparison.CurrentCultureIgnoreCase) &&
                       string.Equals(result_code, "SUCCESS", StringComparison.CurrentCultureIgnoreCase);
            }
        }

...
/* 
   API地址：http://mp.WeChat.qq.com/wiki/9/d8a5f3b102915f30516d79b44fe665ed.html
   PDF下载：https://mp.WeChat.qq.com/zh_CN/htmledition/comm_htmledition/res/cardticket/wx_card_document.zip
*/
...
using OneGulp.WeChat.MP.AdvancedAPIs.Card;
...
namespace OneGulp.WeChat.MP.AdvancedAPIs
{
    ...
    public static class CardApi
    {
        ...
        /// <summary>
        /// 此接口已取消，微信直接提供了十四种色值供选择，详见：http://mp.WeChat.qq.com/wiki/8/b7e310e7943f7763450eced91fa793b0.html#.E5.8D.A1.E5.88.B8.E5.9F.BA.E7.A1.80.E4.BF.A1.E6.81.AF.E5.AD.97.E6.AE.B5.EF.BC.88.E9.87.8D.E8.A6.81.EF.BC.89
        /// 获取颜色列表接口
        /// </summary>
        /// <param name="accessTokenOrAppId"></param>
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        ...
        /// <summary>
        /// 生成卡券二维码
        /// 获取二维码ticket 后，开发者可用ticket 换取二维码图片。换取指引参考：http://mp.WeChat.qq.com/wiki/index.php?title=生成带参数的二维码
        /// </summary>
        /// <param name="accessTokenOrAppId"></param>
        ...
        public static GetDepositCountResultJson GetDepositCount(string accessTokenOrAppId, string cardId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("http://api.WeiXin.qq.com/card/code/getdepositcount?access_token={0}", accessToken);
        ...
        public static GetHtmlResult GetHtml(string accessTokenOrAppId, string cardId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.WeiXin.qq.com/card/mpnews/gethtml?access_token={0}", accessToken);

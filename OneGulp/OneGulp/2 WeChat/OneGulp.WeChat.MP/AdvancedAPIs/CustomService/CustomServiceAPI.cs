...
/* 
    多客服接口聊天记录接口，官方API：http://mp.WeChat.qq.com/wiki/index.php?title=%E8%8E%B7%E5%8F%96%E5%AE%A2%E6%9C%8D%E8%81%8A%E5%A4%A9%E8%AE%B0%E5%BD%95
*/
...
using OneGulp.WeChat.MP.AdvancedAPIs.CustomService;
    ...
    public static class CustomServiceApi
    {
        ...
        public static GetRecordResult GetRecord(string accessTokenOrAppId, DateTime startTime, DateTime endTime, string openId = null, int pageSize = 10, int pageIndex = 1, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                var data = new
                {
                    starttime = DateTimeHelper.GetWeChatDateTime(startTime),
                    endtime = DateTimeHelper.GetWeChatDateTime(endTime),
                    openId = openId,
                    pagesize = pageSize,
                    pageIndex = pageIndex
                };

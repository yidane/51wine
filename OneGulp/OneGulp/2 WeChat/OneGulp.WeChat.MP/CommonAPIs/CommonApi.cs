...
/*
    API：http://mp.WeChat.qq.com/wiki/index.php?title=%E6%8E%A5%E5%8F%A3%E6%96%87%E6%A1%A3&oldid=103
...
namespace OneGulp.WeChat.MP.CommonAPIs
{
    ...
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        public static WeChatUserInfoResult GetUserInfo(string accessTokenOrAppId, string openId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("http://api.WeiXin.qq.com/cgi-bin/user/info?access_token={0}&openid={1}",
                                        accessToken, openId);
                WeChatUserInfoResult result = Get.GetJson<WeChatUserInfoResult>(url);
                return result;
        ...
        {
            var accessToken = AccessTokenContainer.TryGetToken(appId, secret, true);

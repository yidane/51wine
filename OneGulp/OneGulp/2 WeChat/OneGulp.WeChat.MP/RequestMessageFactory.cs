...
namespace OneGulp.WeChat.MP
{
    ...
    public static class RequestMessageFactory
    {
        ...
        public static IRequestMessageBase GetRequestEntity(XDocument doc, PostModel postModel = null)
        {
                    ...
                    case RequestMsgType.Event:
                        ...
                        switch (doc.Root.Element("Event").Value.ToUpper())
                        {
                            ...
                            case "PIC_PHOTO_OR_ALBUM"://弹出拍照或者相册发图（pic_photo_or_album）
                                ...
                                break;
                            case "PIC_WeChat"://弹出微信相册发图器(pic_WeChat)
                                requestMessage = new RequestMessageEvent_Pic_WeChat();
                                break;
            ...
            {
                throw new WeChatException(string.Format("RequestMessage转换出错！可能是MsgType不存在！，XML：{0}", doc.ToString()), ex);
            }

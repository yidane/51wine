...
{
	public interface IResponseMessageBase : WeChat.Entities.IResponseMessageBase
	{
	...
	/// 响应回复消息
	/// </summary>
    public class ResponseMessageBase : WeChat.Entities.ResponseMessageBase, IResponseMessageBase
	{
		...
		public static ResponseMessageBase CreateFromRequestMessage(IRequestMessageBase requestMessage, ResponseMsgType msgType)
		{
			...
			{
				throw new WeChatException("CreateFromRequestMessage过程发生异常", ex);
			}
		...
		public static T CreateFromRequestMessage<T>(IRequestMessageBase requestMessage) where T : ResponseMessageBase
		{
			...
			{
				throw new WeChatException("ResponseMessageBase.CreateFromRequestMessage<T>过程发生异常！", ex);
			}
		}
		...
		public static IResponseMessageBase CreateFromResponseXml(string xml)
		{
			...
			{
				throw new WeChatException("ResponseMessageBase.CreateFromResponseXml<T>过程发生异常！" + ex.Message, ex);
			}
		}
	}
}

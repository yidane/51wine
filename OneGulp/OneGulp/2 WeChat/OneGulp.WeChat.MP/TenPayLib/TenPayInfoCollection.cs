...
namespace OneGulp.WeChat.MP.TenPayLib
{
    /// <summary>
    ...
    public class TenPayInfoCollection : Dictionary<string, TenPayInfo>
    {
        ...
        public static void Register(TenPayInfo WeChatPayInfo)
        {
            Data[WeChatPayInfo.PartnerId] = WeChatPayInfo;
        }
        ...
        new public TenPayInfo this[string key]
        {
            get
            {
                ...
                {
                    throw new WeChatException(string.Format("WeChatPayInfoCollection尚未注册Partner：{0}", key));
                }
                else
                {
                    return base[key];

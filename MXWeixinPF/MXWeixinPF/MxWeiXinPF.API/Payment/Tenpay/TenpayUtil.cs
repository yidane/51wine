...
namespace MxWeiXinPF.API.Payment.Tenpay
{
	/// <summary>
	/// TenpayUtil 的摘要说明。
	/// </summary>
	public class TenpayUtil
	{
        ...
        public static string key  = ""; //财付通密钥;
        public static string type = "1"; //接口类型1即时到帐2担保交易
        public static string return_url = ""; //显示支付通知页面;

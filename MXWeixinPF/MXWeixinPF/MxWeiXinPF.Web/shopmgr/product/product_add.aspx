<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_add.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.product.product_add" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a  href="../category/category_list.aspx"><span class="btn yellow">返回上一页</span></a>

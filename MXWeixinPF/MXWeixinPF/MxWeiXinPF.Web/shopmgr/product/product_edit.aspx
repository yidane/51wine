<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_edit.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.product.product_edit" ValidateRequest="false"  %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="javascript:;" class="home"><i></i><span>编辑商品</span></a>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                  ...
                  <span class="red">如更改商品类型，则商品原来的属性就丢失。</span>
                </dd>
            </dl>

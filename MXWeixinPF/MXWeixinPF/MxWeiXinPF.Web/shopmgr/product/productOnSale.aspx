<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productOnSale.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.product.productOnSale" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:;" class="home"><i></i><span>出售中的商品</span></a>
        </div>
        <!--/导航栏-->
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li><a class="icon-btn add" href="product_add.aspx?frompage=productOnSale.aspx" id="itemAddButton"><i></i><span>新增商品</span></a></li>
                        <li>
                            <asp:LinkButton ID="btnSave" runat="server" CssClass="save" OnClick="btnSave_Click"><i></i><span>保存排序</span></asp:LinkButton></li>
                         <li>
                            <asp:LinkButton ID="btnXiJia" runat="server" CssClass="folder" OnClick="btnXiJia_Click"><i></i><span>下架商品</span></asp:LinkButton></li>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnItemDataBound="rptList_ItemDataBound">
            ...
            <ItemTemplate>
                <tr class="td_c">
                    ...
                    <td>
                        <a href='product_edit.aspx?id=<%#Eval("id") %>&frompage=productOnSale.aspx' class="operator">编辑</a>

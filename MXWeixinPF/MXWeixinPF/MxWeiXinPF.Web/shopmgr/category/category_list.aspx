<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_list.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.category.category_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a   class="home"><i></i><span>商品分类管理</span></a>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_list.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.setting.payment_list" %>
...
<div class="location">
  ...
  <a href="javascript:;" class="home"><i></i><span>支付方式</span></a>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="payment_select.aspx"><i></i><span>新增支付方式</span></a></li>

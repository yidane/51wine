<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_edit.aspx.cs" Inherits="MxWeiXinPF.Web.shopmgr.catalog.attribute_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a href="attribute_list.aspx?id=<%=catalogId %>"><span class="btn yellow">返回上一页</span></a>

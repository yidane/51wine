<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.product.all" %>
...
<body id="cate9">
    <form id="form1" runat="server">
        ...
        <div class="catemenu">
            <ul>
                <asp:Literal ID="litTypeInfo" runat="server" Text=""></asp:Literal>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.product.detail" %>
...
<body id="news">
    <form id="form1" runat="server">
        ...
        <div class="top_bar" style="-webkit-transform: translate3d(0,0,0)" id="top_bar">
            <nav>

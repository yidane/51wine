<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="duihuan.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.ucard.duihuan" %>
...
<body id="cardpower" onload="new Accordian('basic-accordian',2,'header_highlight');" class="mode_webapp2">
    <form id="form1" runat="server">
        ...
        <div id="basic-accordian">
            <asp:Literal ID="litGiftlist" runat="server" EnableViewState="false"></asp:Literal>
        </div>
        ...
        <div class="footermenu">
            <ul>
                ...
                <li>
                    <a class="active" href="duihuan.aspx?wid=<%=wid%>&sid=<%=sid%>&openid=<%=openid%>">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ucardTicket.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.ucard.ucardTicket" %>
...
<body id="cardpower" onload="new Accordian('basic-accordian',2,'header_highlight');" class="mode_webapp2">
    <form id="form1" runat="server">
        ...
        <div id="basic-accordian">
             <asp:Literal ID="litTicketlist" runat="server" EnableViewState="false"></asp:Literal>
        ...
        <script>
            ...
            function coupon(i, sncode, cid) {
                ...
                if( jQ('#cid' +cid).text()=="0")
                {
                    document.getElementById('sn' + i).innerHTML = '已领取完!';
                    return;
                }
                ...
                function (data) {
                    if (data.ret == "succ") {
                        ...
                        document.getElementById('bmoney' + i).value = '';
                        jQ('#cid' +cid).text(data.sy);
        ...
        <script src="js/plugback.js" type="text/javascript" ></script>
         ...
         <div class="footermenu">
            <ul>
                ...
                <li>
                    <a class="active" href="ucardTicket.aspx?wid=<%=wid %>&sid=<%=sid%>&openid=<%=openid%>">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ucardlist.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.ucard.ucardlist" %>
...
<body id="cardunion" class="mode_webapp2">
    <form id="form1" runat="server">
        ...
        <div class="cardexplain">
            ...
            <!--我的会员卡-->
            <ul class="round">
                <li><a href="myUcard.aspx?wid=<%=wid%>&openid=<%=openid%>"><span>我的会员卡<em class="ok">
                    <asp:Literal ID="lituStoreNum" runat="server" EnableViewState="false"></asp:Literal>
                                                                                      </em></span></a></li>
            </ul>

            <ul class="round">
                <li class="title"><span>会员卡商家<em class="more"> </em></span></li>
            ...
            <ul class="round">
                ...
                <li class="detail">
                    <a href="zsdetail.aspx?wid=<%=wid%>&openid=<%=openid%>"><span>查看详情</span></a>
        ...
        <div class="footermenu">
            <ul>
                ...
                <li>
                    <a class="active" href="ucardlist.aspx?wid=<%=wid%>&openid=<%=openid%>">

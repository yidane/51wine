...
{
    public partial class ershouche : WeiXinPage
    {
        protected int wid;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable ds = acBll.GetList(" wid=" + wid + " and id=" + wzModel.escid);
                if (ds.Rows.Count > 0)
                    acModel = acBll.GetModel(MyCommFun.Obj2Int(wzModel.escid));

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qjt.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.wqiche.qjt" %>
...
<body onselectstart="return true;" ondragstart="return false;">
    ...
    <script type="text/javascript">
        if (ggHasHtml5Css3D() || ggHasWebGL()) {
            ...
            pano.readConfigUrl('xmlstr.aspx?id=<%=id%>&wid=<%=wid%>&openid=<%=openid%>');
        } else {
    ...
    <div class='view_change'>
        <a href='qjtList.aspx?wid=<%=wid %>&openid=<%=openid %>'><%=title %></a>
    </div>
    <a href="qjtList.aspx?wid=<%=wid %>&openid=<%=openid %>" class="back360" style="">&nbsp;</a>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gzReg.aspx.cs" Inherits="MxWeiXinPF.Web.weixin.zhanhui.gzReg" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#gz_reg").click(function () {
                ...
                $.post("getdata.ashx?myact=addGz&v=" + Math.random(), req, function (data) {
                    if (data.res != 1) {
                        alert("添加错误！");
                        return;
                    }
                    location.href = "gzReg_ret.aspx?gzid=" + data.content;
                }, "json");
            ...
            <ul class="round" style="list-style: none;">
                ...
                <li class="nob" style="padding-right: 5px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
                        <tbody>
                            <tr class="line">
                                <td id="Td5" height="30" width="32%" style="border-bottom: none; text-align: center">
                                    <input id="gz_reg" type="button" value="观众登记" />
                                </td>
                            </tr>
                        </tbody>
                    </table>

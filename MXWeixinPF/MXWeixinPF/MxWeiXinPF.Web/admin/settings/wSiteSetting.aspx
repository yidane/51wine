<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wSiteSetting.aspx.cs" Inherits="MxWeiXinPF.Web.admin.settings.wSiteSetting" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-img").each(function () {
                $(this).InitSWFUpload({ sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.mp3;*.mp4" });
            });
        });
    </script>
</head>

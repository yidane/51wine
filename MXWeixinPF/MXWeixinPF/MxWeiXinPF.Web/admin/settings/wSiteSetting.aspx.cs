...
namespace MxWeiXinPF.Web.admin.settings
{
    ...
    {
        MxWeiXinPF.BLL.wx_wsite_setting bll = new MxWeiXinPF.BLL.wx_wsite_setting();
        ...
        private void ShowInfo()
        {
            ...
            IList<MxWeiXinPF.Model.wx_wsite_setting> modellist = bll.GetModelList("wId="+weixin.id);
            if (modellist == null || modellist.Count <= 0)
            {
                return;
            }
            MxWeiXinPF.Model.wx_wsite_setting model = modellist[0];

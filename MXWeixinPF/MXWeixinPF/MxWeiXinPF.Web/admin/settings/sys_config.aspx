<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="MxWeiXinPF.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
           ...
           <dl>
                ...
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList ID="radOnlyWeixinLook" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            <asp:ListItem Value="0" Selected="True">关闭</asp:ListItem>
                            <asp:ListItem Value="1">开启</asp:ListItem>
                           
                        </asp:RadioButtonList>
                    </div>
                    <span class="Validform_checktip">*前端微信相关页面页面禁止在非微信浏览器访问，则开启该功能</span>
                </dd>
            </dl>
      ...
      <span class="Validform_checktip">*文字水印的字体和大小 </span>
        ...
        <div class="tab-content" style="display: none">
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">尚未申请？<a href="http://m.uweixin.cn" target="_blank">请点击这里注册</a></span>
                </dd>
            </dl>
            <dl>
                <dt>短信API地址</dt>
            ...
            <dl>
                ...
                <dd>请不要使用系统默认账户test，因为它是公用的测试账号；<br />
                    如果您尚未申请开通，<a href="http://m.uweixin.cn" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
                </dd>
            </dl>
        </div>
        <!--/手机短信设置-->
        ...
        <div style="display:none;" id="woyaoyincang">
             <dl>
                <dt>URL重写开关</dt>
                <dd>
                    <div class="rule-multi-radio">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-checkbox">
                        <asp:CheckBox ID="mobilestatus" runat="server" />
                    </div>
                    <span class="Validform_checktip">*开启后不绑定域名则以二级目录/mobile/访问</span>
                </dd>
            </dl>
            <dl>
                <dt>手机网站域名</dt>
                <dd>
                    <asp:TextBox ID="mobiledomain" runat="server" CssClass="input txt" datatype="/^\s*$|^([a-zA-Z0-9\-\u4e00-\u9fa5]+\.)+[a-zA-Z\u4e00-\u9fa5]+$/" errormsg="请输入正确的域名！" sucmsg=" " />

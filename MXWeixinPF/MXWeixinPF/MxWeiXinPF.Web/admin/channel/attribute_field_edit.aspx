<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.channel.attribute_field_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>字段列名</dt>
                <dd>
                    <asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=attribute_field_validate"></asp:TextBox>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*中文标题，做为备注</span></dd>
            </dl>
            ...
            <dl id="dlDataLength" runat="server" class="single-text-tr multi-text-tr multi-radio-tr multi-checkbox-tr">
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*数字，默认50个字符</span></dd>
            </dl>
            ...
            <dl id="dlItemOption" runat="server" class="multi-radio-tr multi-checkbox-tr">
                <dt>选项列表</dt>
                <dd>
                    <asp:TextBox ID="txtItemOption" runat="server" CssClass="input" TextMode="MultiLine" datatype="*" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*控件的默认字符，可为空</span></dd>
            </dl>

            <dl id="dlValidPattern" runat="server">
                <dt>验证正则表达式</dt>
                <dd>
                    <asp:TextBox ID="txtValidPattern" runat="server" CssClass="input" TextMode="MultiLine"></asp:TextBox>
                    <span class="Validform_checktip">*不填写则不验证</span></dd>
            </dl>

            <dl>
                <dt>验证提示信息</dt>
                <dd>
                    <asp:TextBox ID="txtValidTipMsg" runat="server" CssClass="input" TextMode="MultiLine"></asp:TextBox></dd>
            </dl>

            <dl id="dlValidErrorMsg" runat="server">
                <dt>验证失败信息</dt>
                <dd>
                    <asp:TextBox ID="txtValidErrorMsg" runat="server" CssClass="input" TextMode="MultiLine"></asp:TextBox></dd>
            </dl>

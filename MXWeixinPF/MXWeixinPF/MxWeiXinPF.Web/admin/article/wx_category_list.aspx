<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_category_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_category_list" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="wx_category_edit.aspx?action=<%#MXEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
                    </td>
                    <td>

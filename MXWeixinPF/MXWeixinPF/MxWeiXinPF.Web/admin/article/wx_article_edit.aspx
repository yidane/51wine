<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_article_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_article_edit" ValidateRequest="false"  %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var editor = KindEditor.create('.editor', {
                ...
                height: '350px',
                resizeType: 1,
                uploadJson: '../../tools/upload_ajax.ashx?action=EditorFile&IsWater=1',//指定上传文件的服务器端程序。
                fileManagerJson: '../../tools/upload_ajax.ashx?action=ManagerFile',//指定浏览远程图片的服务器端程序。
                allowFileManager: true//rue时显示浏览远程服务器按钮。
            });
            var editorMini = KindEditor.create('.editor-mini', {
                ...
                items: [
                    ...
                    'insertunorderedlist', '|', 'emoticons', 'image', 'link']//配置编辑器的工具栏，其中”/”表示换行，”|”表示分隔符。
            });
            //初始化上传控件
            $(".upload-img").each(function () {
                $(this).InitSWFUpload({ sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.<%=siteConfig.fileextension.Replace(",",";*.") %>;*.mp4" });
            });
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="wx_article_list.aspx?channel_id=<%=this.channel_id %>" class="home"><i></i><span>文章管理</span></a>
            <i class="arrow"></i>
            <span>编辑信息</span>
        </div>
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">其他信息</a></li>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <input id="selectmoduleinfo" type="button" value="选择" class="btn" />
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
        ...
        <div class="tab-content" style="display: none">
            ...
            <dl id="div_author" runat="server" visible="false">
                ...
                <dd>
                    <asp:TextBox ID="field_control_author" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>

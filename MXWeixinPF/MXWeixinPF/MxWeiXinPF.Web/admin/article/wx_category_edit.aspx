<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_category_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_category_edit" ValidateRequest="false"  %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>分类介绍</dt>
                <dd>
                    <textarea id="txtContent"  rows="4" class="normal" style="width:90%;" runat="server"></textarea>
                </dd>
            </dl>

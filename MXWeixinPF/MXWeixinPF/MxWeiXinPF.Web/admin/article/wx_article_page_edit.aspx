<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_article_page_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_article_page_edit" ValidateRequest="false"  %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="wx_article_page_list.aspx?channel_id=<%=this.channel_id %>" class="home"><i></i><span>单页管理</span></a>
            <i class="arrow"></i>
            <span>编辑单页信息</span>
        </div>
              ...
              <dl  >
                ...
                <dd>
                    <div class="rule-multi-radio">
                     ...
                     <span class="Validform_checktip">*（仅限汽车模版）只控制在首页是否显示，其他不做限制</span>
                </dd>
            </dl>

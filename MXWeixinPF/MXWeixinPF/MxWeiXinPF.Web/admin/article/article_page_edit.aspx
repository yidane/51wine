<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_page_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.article_page_edit" ValidateRequest="false"%>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="article_list.aspx?channel_id=<%=this.channel_id %>" class="home"><i></i><span>单页管理</span></a>
            <i class="arrow"></i>
            <span>编辑单页信息</span>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advmgr.aspx.cs" Inherits="MxWeiXinPF.Web.admin.qiangpiao.advmgr" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="action_list.aspx" class="back"><i></i><span>返回电影院抢票</span></a>
            <i class="arrow"></i>
            <span>广告管理</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">广告管理</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="photo-list">
                        <ul>
                            <asp:Repeater ID="rptAlbumList" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <input type="hidden" name="hid_photo_name" value="<%#Eval("id")%>|<%#Eval("imgPic")%>|" />

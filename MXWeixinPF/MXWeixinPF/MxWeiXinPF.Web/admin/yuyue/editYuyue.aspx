<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editYuyue.aspx.cs" Inherits="MxWeiXinPF.Web.admin.yuyue.editYuyue" ValidateRequest="false"  %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="mytips">
            该预约的地址：<a href="javascript:;"><asp:Literal ID="litwUrl" runat="server" Text=""></asp:Literal></a><br />
              <span style="color:red;">注：1 如果该表单已经产生用户数据，请勿做任何的修改。<br />
                2 表单显示名称不能有重名</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
              ...
              <dl>
                ...
                <dd>
                      <div class="rule-multi-radio">
                        <asp:RadioButtonList ID="rblPICType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            <asp:ListItem Value="0" Selected="True">否</asp:ListItem>
                            <asp:ListItem Value="1">是</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>

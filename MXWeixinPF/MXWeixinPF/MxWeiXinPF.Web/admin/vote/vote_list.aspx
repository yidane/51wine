<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vote_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.vote.vote_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    ...
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="vote_character_add.aspx?action=<%=MxWeiXinPF.Common.MXEnums.ActionEnum.Add %>" id="itemAddButton"><i></i><span>发起文字投票</span></a></li>
                        <li><a class="icon-btn add" href="vote_picture_add.aspx?action=<%=MxWeiXinPF.Common.MXEnums.ActionEnum.Add %>" id="itemBlackButton"><i></i><span>发起图片投票</span></a></li>

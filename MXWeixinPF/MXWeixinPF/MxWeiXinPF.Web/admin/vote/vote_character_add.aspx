<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vote_character_add.aspx.cs" Inherits="MxWeiXinPF.Web.admin.vote.vote_character_add" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
          <!--导航栏-->
        <div class="location">
            <a href="vote_list.aspx" class="home"><i></i><span>投票活动列表</span></a>
            <i class="arrow"></i> 
            <span>文本投票设置</span>
        </div>
          ...
          <dl>
           ...
           <div class="page-footer" >
            <div class="btn-list">
                ...
                <a href="vote_list.aspx"><span class="btn yellow">取消</span></a>

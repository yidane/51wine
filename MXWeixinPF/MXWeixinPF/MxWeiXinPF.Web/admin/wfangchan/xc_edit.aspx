<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xc_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wfangchan.xc_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="xcMgr.aspx?id=<%=fid %>" class="back"><i></i><span>相册管理</span></a>
            <i class="arrow"></i>
            <span>编辑楼盘相册</span>
        </div>

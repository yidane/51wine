<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MxWeiXinPF.Web.admin.index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>后台管理中心 版本号：<%=MxWeiXinPF.Common.MXKeys.ASSEMBLY_VERSION %></title>
...
<div class="header">
  <div class="header-box">
   <a href="index.aspx"  id="indexUrl" runat="server"> <h1 class="logo"></h1></a>

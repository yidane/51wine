<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ggkEdit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.choujiang.ggkEdit"  ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑刮刮奖活动开始内容</a></li>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    ...
                    <asp:TextBox ID="txtKW" runat="server" CssClass="input normal" datatype="*1-20" sucmsg=" " Text="刮刮卡" />
            ...
            <dl>
                <dt>开始活动的图片</dt>
                <dd>
                    <asp:Image ID="imgbeginPic" runat="server" ImageUrl="/weixin/ggk/images/start.jpg" Style="max-height: 80px;" />
            ...
            <dl>
                <dt>简介</dt>
                <dd>
                    <textarea name="txtbrief" rows="2" cols="20" id="txtbrief" class="editor-mini" runat="server" datatype="*1-2000" sucmsg=" " nullmsg=" " style="visibility: hidden;"></textarea>
            ...
            <dl>
                <dt>推送说明</dt>
                <dd>
                    <textarea name="txtactContent" rows="2" cols="20" id="txtactContent" class="input" runat="server">亲，请点击进入刮刮奖活动页面，祝您好运哦！</textarea>
                    <span class="Validform_checktip"></span>
                </dd>
            </dl>
        ...
        <div class="tab-content" style="display: none">
            <dl>
                <dt>活动结束的图片</dt>
                <dd>
                    <asp:Image ID="imgEndPic" runat="server" ImageUrl="/weixin/ggk/images/end.jpg" Style="max-height: 80px;" />
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a href="ggklist.aspx"><span class="btn yellow">返回上一页</span></a>

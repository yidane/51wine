<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenBenList.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wxRule.wenBenList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="editWenBen.aspx?action=<%=MXEnums.ActionEnum.Add %>"><i></i><span>添加文本回复</span></a></li>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yuYinList.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wxRule.yuYinList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="editYuYin.aspx?action=<%=MXEnums.ActionEnum.Add %>"><i></i><span>添加语音回复</span></a></li>

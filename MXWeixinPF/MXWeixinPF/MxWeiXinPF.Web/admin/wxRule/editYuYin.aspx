<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editYuYin.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wxRule.editYuYin" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="yuYinList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <i class="arrow"></i>
            <span>语音回复</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">语音回复</a></li>
                    </ul>
                </div>
            </div>
        </div>

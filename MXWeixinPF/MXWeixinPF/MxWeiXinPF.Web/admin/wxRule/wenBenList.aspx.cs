...
{
    public partial class wenBenList : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            _strWhere = "wId=" + weixin.id + "and reqestType=1 and responseType=1 and (modelFunctionName is null or modelFunctionName='')" + _strWhere;

...
{
    public partial class tuwenMgr : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Model.wx_requestRule rule = rbll.GetModel(rid);
                this.lblKeyWords.Text =MyCommFun.SubStrAddSuffix(rule.reqKeywords,10,"...");
                hlAddTuWen.NavigateUrl = "editTuWen.aspx?rid=" + rid + "&action=" + MXEnums.ActionEnum.Add;
                RptBind();
            }
        }
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                hlEdit.NavigateUrl = "editTuWen.aspx?rid=" + rid + "&id=" + hidId.Value + "&action=" + MXEnums.ActionEnum.Edit;
            }
        }
    }
}
...
{
    public partial class dianyuan_manage : Web.UI.ManagePage
    {
        protected int totalCount;
        protected int page;
        protected int pageSize;
        BLL.wx_diancai_dianyuan gbll = new BLL.wx_diancai_dianyuan();
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and  dianyuanName like  '%" + _keywords + "%' ");
            }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("dianyuan_manage_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dianyuan_manage.aspx?shopid=" + shopid + "", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("dianyuan_manage_page_size", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("dianyuan_manage.aspx?shopid=" + shopid + "", "keywords={0}", this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("dianyuan_manage.aspx?shopid=" + shopid + "", "keywords={0}", this.keywords), "Success");
        }

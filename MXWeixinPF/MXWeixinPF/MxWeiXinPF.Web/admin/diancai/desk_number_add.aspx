<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="desk_number_add.aspx.cs" Inherits="MxWeiXinPF.Web.admin.diancai.desk_number_add" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
      <div class="location">
            ...
            <i class="arrow"></i><span><a href="desk_number.aspx?shopid=<%=shopid %>" >桌号设置</a></span>
            <i class="arrow"></i>             
            <span>桌号设置</span>
        </div>
          ...
          <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">桌号设置</a></li>
               ...
               <div  class="tab-content" >
                <dl>
                   ...
                   <dl>
                    <dt>桌号名称：</dt>
                    <dd>
                        <asp:TextBox runat="server" ID="deskName" CssClass="input normal" sucmsg=" " nullmsg="" datatype="*1-100" ></asp:TextBox>
                        <span class="Validform_checktip">*</span>
                    </dd>
                </dl>

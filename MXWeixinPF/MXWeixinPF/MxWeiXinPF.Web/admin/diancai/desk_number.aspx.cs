...
{
    public partial class desk_number : Web.UI.ManagePage
    {
        protected int totalCount;
        protected int page;
        protected int pageSize;
        BLL.wx_diancai_desknum gbll = new BLL.wx_diancai_desknum();
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and  deskName like  '%" + _keywords + "%' ");
            }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("desk_number_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("desk_number.aspx", "keywords={0}&shopid={1}", txtKeywords.Text, shopid.ToString()));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("desk_number_page_size", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("desk_number.aspx", "keywords={0}&shopid={1}", this.keywords, shopid.ToString()));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("desk_number.aspx", "keywords={0}&shopid={1}", this.keywords, shopid.ToString()), "Success");
        }

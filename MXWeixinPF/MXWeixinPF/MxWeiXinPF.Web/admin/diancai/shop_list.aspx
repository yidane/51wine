<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.diancai.shop_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="shop_add.aspx?action=<%=MxWeiXinPF.Common.MXEnums.ActionEnum.Add %>&type=add"  id="itemAddButton"><i></i><span>新增商家或门店</span></a></li>
                       <%-- <li><a class="icon-btn add" href="shop_setup.aspx?action=<%=MxWeiXinPF.Common.MXEnums.ActionEnum.Add %>&type=add"  id="itemButton"><i></i><span>商城设置</span></a></li>--%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pic_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wxpicInterface.pic_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:;" class="home"><i></i><span>微拍-图片管理</span></a>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="inferface_setting.aspx" id="itemAddButton"><i></i><span>微拍接口设置</span></a></li>
        ...
        <!--列表-->
         ...
         <asp:Repeater ID="rptList2" runat="server" >
            ...
            <ItemTemplate>
                <li>
                    <div class="details<%#Eval("picUrl").ToString() != "" ? "" : " nopic"%>">
                        <div class="check">
                            <asp:CheckBox ID="chkId" CssClass="checkall" runat="server" /><asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                        </div>
                        <%#Eval("picUrl").ToString() != "" ? "<div class=\"pic\"><img src=\"../skin/default/loadimg.gif\" data-original=\"" + Eval("picUrl") + "\" /></div><i class=\"absbg\"></i>" : ""%>
                        <h1><span><%#Eval("remark")%></span></h1>
                        <div class="remark" style=" height:20px;">
                            <%#Eval("openid").ToString() == "" ? "无openid" : Eval("openid").ToString()%>
                        </div>

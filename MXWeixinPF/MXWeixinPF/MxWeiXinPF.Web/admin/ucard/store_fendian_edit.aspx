<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="store_fendian_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.store_fendian_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location"> 
            <a href="store_fendian.aspx?id=<%=sid %>" class="home"><span>分店列表</span></a>
            <i class="arrow"></i>
            <span>分店设置</span>
        </div>

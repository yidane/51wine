<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="card_design.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.card_design" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:void(0)" class="home"><i></i><span>卡版面设置</span></a> 
        </div>

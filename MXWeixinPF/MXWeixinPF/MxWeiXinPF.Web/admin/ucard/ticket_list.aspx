<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ticket_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.ticket_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
          <!--导航栏-->
        <div class="location">
            <a href="javascript:void(0)" class="home"><i></i><span>会员相关优惠券</span></a> 
        </div>

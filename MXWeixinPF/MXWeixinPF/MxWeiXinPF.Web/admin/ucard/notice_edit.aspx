<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notice_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.notice_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location"> 
            <a href="notice_list.aspx?id=<%=sid %>" class="home"><span>通知列表</span></a>
            <i class="arrow"></i>
            <span>分店设置</span>
        </div>

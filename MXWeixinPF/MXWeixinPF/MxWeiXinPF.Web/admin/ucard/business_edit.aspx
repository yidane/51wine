<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.business_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:void(0)" class="home"><i></i><span>商家设置</span></a>
        </div>
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a href="javascript:void(0)"><span class="btn yellow">返回上一页</span></a>

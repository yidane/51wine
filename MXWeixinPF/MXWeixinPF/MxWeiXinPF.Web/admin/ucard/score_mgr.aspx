<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="score_mgr.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.score_mgr" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:void(0)" class="home"><i></i><span>积分设置</span></a> 
        </div>

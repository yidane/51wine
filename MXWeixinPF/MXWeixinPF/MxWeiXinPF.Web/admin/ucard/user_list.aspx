<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.ucard.user_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:void(0)" class="home"><i></i><span>会员管理</span></a> 
        </div>

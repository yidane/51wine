<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sygj_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wqiche.sygj_edit" %> 
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="sygjMgr.aspx" class="home"><i></i><span>实用工具管理</span></a>
            <i class="arrow"></i>
            <span>编辑实用工具</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>URL</dt>
                <dd>
                    <asp:TextBox ID="txtUrl" runat="server" CssClass="input normal" datatype="*1-500" sucmsg=" " Text="" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mybill_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.agent.mybill_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="bill_list.aspx" class="home"><i></i><span>我的消费记录</span></a>

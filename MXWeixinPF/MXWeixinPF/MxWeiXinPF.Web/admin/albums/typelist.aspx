<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="typelist.aspx.cs" Inherits="MxWeiXinPF.Web.admin.albums.typelist" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="type_edit.aspx?action=<%=MXEnums.ActionEnum.Add %>" id="itemAddButton"><i></i><span>新增相册分类</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr class="td_c">
                    ...
                    <td>
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("typeIco") %>' Style="max-height: 80px;" />
                    ...
                    <td>
                      ...
                      <td>
                        <%# Eval("showType").ToString()=="1"?"显示":"隐藏" %>
                    </td>
                    <td>
                        <%# Eval("sort_id") %>
                    </td>
                    <td>
                        <a href='type_edit.aspx?id=<%#Eval("id") %>&action=<%=MXEnums.ActionEnum.Edit %>' class="operator">编辑</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>

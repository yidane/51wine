<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editPhoto.aspx.cs" Inherits="MxWeiXinPF.Web.admin.albums.editPhoto" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="photolist.aspx?id=<%=aid %>"><span>图片列表</span></a>
            <i class="arrow"></i>
            <span>图片编辑</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>图片说明</dt>
                <dd>
                    <textarea name="txtpContent" rows="2" cols="20" id="txtpContent" class="input" runat="server" datatype="*1-300" sucmsg=" " nullmsg=" "></textarea>
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a href="photolist.aspx?id=<%=aid %>"><span class="btn yellow">返回上一页</span></a>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hotel_form.aspx.cs" Inherits="MxWeiXinPF.Web.admin.hotel.hotel_form" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="location">
            <a href="hotel_list.aspx" class="home"><i></i><span>点菜系统</span></a>
            <i class="arrow"></i>
            <span>表单设置</span>
        </div>

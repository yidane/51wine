...
namespace MxWeiXinPF.BLL
{
    ...
    {
        private readonly MxWeiXinPF.DAL.wx_hb_haibao dal = new MxWeiXinPF.DAL.wx_hb_haibao();
        public wx_hb_haibao()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hb_haibao> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hb_haibao> DataTableToList(DataTable dt)
        {
            List<MxWeiXinPF.Model.wx_hb_haibao> modelList = new List<MxWeiXinPF.Model.wx_hb_haibao>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MxWeiXinPF.Model.wx_hb_haibao model;

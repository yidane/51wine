...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_qp_users dal=new MxWeiXinPF.DAL.wx_qp_users();
		public wx_qp_users()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_qp_users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_qp_users> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_qp_users> modelList = new List<MxWeiXinPF.Model.wx_qp_users>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_qp_users model;

...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_message_setting dal=new MxWeiXinPF.DAL.wx_message_setting();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_message_setting> GetModelList(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_message_setting> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_message_setting> modelList = new List<MxWeiXinPF.Model.wx_message_setting>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_message_setting model;

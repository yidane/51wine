...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_sTicket dal=new MxWeiXinPF.DAL.wx_sTicket();
		public wx_sTicket()
		{}
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_sTicket> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_sTicket> DataTableToList(DataTable dt)
        {
            List<MxWeiXinPF.Model.wx_sTicket> modelList = new List<MxWeiXinPF.Model.wx_sTicket>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MxWeiXinPF.Model.wx_sTicket model;

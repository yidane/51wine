...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_hotel_dingdan dal=new MxWeiXinPF.DAL.wx_hotel_dingdan();
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hotel_dingdan> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hotel_dingdan> DataTableToList(DataTable dt)
        {
            List<MxWeiXinPF.Model.wx_hotel_dingdan> modelList = new List<MxWeiXinPF.Model.wx_hotel_dingdan>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MxWeiXinPF.Model.wx_hotel_dingdan model;

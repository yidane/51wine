...
namespace MxWeiXinPF.BLL
{
    ...
    {
        private readonly MxWeiXinPF.DAL.wx_hb_typeImgGroup dal = new MxWeiXinPF.DAL.wx_hb_typeImgGroup();
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hb_typeImgGroup> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_hb_typeImgGroup> DataTableToList(DataTable dt)
        {
            List<MxWeiXinPF.Model.wx_hb_typeImgGroup> modelList = new List<MxWeiXinPF.Model.wx_hb_typeImgGroup>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MxWeiXinPF.Model.wx_hb_typeImgGroup model;

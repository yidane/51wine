...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_qp_film dal=new MxWeiXinPF.DAL.wx_qp_film();
		public wx_qp_film()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_qp_film> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_qp_film> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_qp_film> modelList = new List<MxWeiXinPF.Model.wx_qp_film>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_qp_film model;

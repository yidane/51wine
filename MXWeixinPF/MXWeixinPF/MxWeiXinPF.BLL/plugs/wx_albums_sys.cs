...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_albums_sys dal=new MxWeiXinPF.DAL.wx_albums_sys();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_albums_sys> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_albums_sys> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_albums_sys> modelList = new List<MxWeiXinPF.Model.wx_albums_sys>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_albums_sys model;

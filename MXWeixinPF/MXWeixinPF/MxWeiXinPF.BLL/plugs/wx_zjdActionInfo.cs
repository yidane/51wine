...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_zjdActionInfo dal=new MxWeiXinPF.DAL.wx_zjdActionInfo();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_zjdActionInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_zjdActionInfo> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_zjdActionInfo> modelList = new List<MxWeiXinPF.Model.wx_zjdActionInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_zjdActionInfo model;

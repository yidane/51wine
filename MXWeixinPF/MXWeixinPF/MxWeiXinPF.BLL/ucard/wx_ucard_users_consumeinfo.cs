...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_ucard_users_consumeinfo dal=new MxWeiXinPF.DAL.wx_ucard_users_consumeinfo();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_ucard_users_consumeinfo model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_ucard_users_consumeinfo GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_ucard_users_consumeinfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_ucard_users_consumeinfo> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_ucard_users_consumeinfo> modelList = new List<MxWeiXinPF.Model.wx_ucard_users_consumeinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_ucard_users_consumeinfo model;

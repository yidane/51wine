...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_lbs_shopInfo dal=new MxWeiXinPF.DAL.wx_lbs_shopInfo();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(MxWeiXinPF.Model.wx_lbs_shopInfo model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_lbs_shopInfo model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_lbs_shopInfo GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_lbs_shopInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_lbs_shopInfo> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_lbs_shopInfo> modelList = new List<MxWeiXinPF.Model.wx_lbs_shopInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_lbs_shopInfo model;

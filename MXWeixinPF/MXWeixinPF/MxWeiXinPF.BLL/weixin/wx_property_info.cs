...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_property_info dal=new MxWeiXinPF.DAL.wx_property_info();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_property_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_property_info> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_property_info> modelList = new List<MxWeiXinPF.Model.wx_property_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_property_info model;
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_property_info GetModelByIName(int wid,string iName)
        {

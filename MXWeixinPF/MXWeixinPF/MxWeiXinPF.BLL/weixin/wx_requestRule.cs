...
namespace MxWeiXinPF.BLL
{
    ...
    {
        private readonly MxWeiXinPF.DAL.wx_requestRule dal = new MxWeiXinPF.DAL.wx_requestRule();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(MxWeiXinPF.Model.wx_requestRule model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(MxWeiXinPF.Model.wx_requestRule model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_requestRule GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_requestRule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_requestRule> DataTableToList(DataTable dt)
        {
            List<MxWeiXinPF.Model.wx_requestRule> modelList = new List<MxWeiXinPF.Model.wx_requestRule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MxWeiXinPF.Model.wx_requestRule model;

...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_paizhao_setting dal=new MxWeiXinPF.DAL.wx_paizhao_setting();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_paizhao_setting> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_paizhao_setting> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_paizhao_setting> modelList = new List<MxWeiXinPF.Model.wx_paizhao_setting>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_paizhao_setting model;

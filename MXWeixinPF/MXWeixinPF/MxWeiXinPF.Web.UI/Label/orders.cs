...
namespace MxWeiXinPF.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected DataTable get_order_list(int wid,int page_size, int page_index, string strwhere, out int totalcount)
        {
            return new BLL.orders().GetList(wid,page_size, page_index, strwhere, "add_time desc,id desc", out totalcount).Tables[0];
        }

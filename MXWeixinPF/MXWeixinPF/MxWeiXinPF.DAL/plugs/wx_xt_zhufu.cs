...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_xt_zhufu
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_xt_zhufu"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_xt_zhufu");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_xt_zhufu model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_xt_zhufu model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_xt_zhufu ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_xt_zhufu GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_xt_zhufu model=new MxWeiXinPF.Model.wx_xt_zhufu();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_xt_zhufu DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_xt_zhufu model=new MxWeiXinPF.Model.wx_xt_zhufu();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,bId,openid,uName,phone,message,createDate ");
			strSql.Append(" FROM wx_xt_zhufu ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,bId,openid,uName,phone,message,createDate ");
			strSql.Append(" FROM wx_xt_zhufu ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_xt_zhufu T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_xt_zhufu";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select  * from wx_xt_zhufu ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where  " + strWhere);
            }

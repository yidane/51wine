...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_hotel_pic
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_hotel_pic"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_hotel_pic");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_hotel_pic model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_hotel_pic model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_hotel_pic set ");
			strSql.Append("hotelid=@hotelid,");
			strSql.Append("title=@title,");
			strSql.Append("sortid=@sortid,");
			strSql.Append("picUrl=@picUrl,");
			strSql.Append("picTiaozhuan=@picTiaozhuan,");
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_hotel_pic GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,hotelid,title,sortid,picUrl,picTiaozhuan,createDate from wx_hotel_pic ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			MxWeiXinPF.Model.wx_hotel_pic model=new MxWeiXinPF.Model.wx_hotel_pic();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_hotel_pic DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_hotel_pic model=new MxWeiXinPF.Model.wx_hotel_pic();
			if (row != null)
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,hotelid,title,sortid,picUrl,picTiaozhuan,createDate ");
			strSql.Append(" FROM wx_hotel_pic ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_hotel_pic T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_hotel_pic";

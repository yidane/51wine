...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_purchase_customer
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_purchase_customer GetModel(int Id)
        {
            ...
            MxWeiXinPF.Model.wx_purchase_customer model = new MxWeiXinPF.Model.wx_purchase_customer();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_purchase_customer DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_purchase_customer model = new MxWeiXinPF.Model.wx_purchase_customer();
            if (row != null)
            {

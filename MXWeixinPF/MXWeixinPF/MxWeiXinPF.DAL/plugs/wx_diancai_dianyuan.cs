...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_dianyuan
	{
		...
		public MxWeiXinPF.Model.wx_diancai_dianyuan GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_dianyuan model=new MxWeiXinPF.Model.wx_diancai_dianyuan();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_dianyuan DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_dianyuan model=new MxWeiXinPF.Model.wx_diancai_dianyuan();
			if (row != null)
			{

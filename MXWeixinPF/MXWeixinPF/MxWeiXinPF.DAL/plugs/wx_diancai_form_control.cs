...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_form_control
	{
		...
		public MxWeiXinPF.Model.wx_diancai_form_control GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_form_control model=new MxWeiXinPF.Model.wx_diancai_form_control();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_form_control DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_form_control model=new MxWeiXinPF.Model.wx_diancai_form_control();
			if (row != null)
			{

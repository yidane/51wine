...
namespace MxWeiXinPF.DAL
{
    ...
    public partial class wx_diancai_dingdan_caiping
    {
        ...
        public MxWeiXinPF.Model.wx_diancai_dingdan_caiping GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_diancai_dingdan_caiping model = new MxWeiXinPF.Model.wx_diancai_dingdan_caiping();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_diancai_dingdan_caiping DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_diancai_dingdan_caiping model = new MxWeiXinPF.Model.wx_diancai_dingdan_caiping();
            if (row != null)
            {

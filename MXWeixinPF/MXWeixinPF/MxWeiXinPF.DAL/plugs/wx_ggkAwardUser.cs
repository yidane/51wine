...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_ggkAwardUser
	{
		...
		public MxWeiXinPF.Model.wx_ggkAwardUser GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_ggkAwardUser model=new MxWeiXinPF.Model.wx_ggkAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_ggkAwardUser DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_ggkAwardUser model=new MxWeiXinPF.Model.wx_ggkAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public MxWeiXinPF.Model.wx_ggkAwardUser getZJinfoByOpenid(int actId, string openid)
        {

...
namespace MxWeiXinPF.DAL
{
    ...
    public partial class wx_hb_imggroup
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "wx_hb_imggroup");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from wx_hb_imggroup");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(MxWeiXinPF.Model.wx_hb_imggroup model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(MxWeiXinPF.Model.wx_hb_imggroup model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from wx_hb_imggroup ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_hb_imggroup GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_hb_imggroup model = new MxWeiXinPF.Model.wx_hb_imggroup();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_hb_imggroup DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_hb_imggroup model = new MxWeiXinPF.Model.wx_hb_imggroup();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,hid,imgurl,sort_id,igName,cratedate ");
            strSql.Append(" FROM wx_hb_imggroup ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,hid,imgurl,sort_id,igName,cratedate ");
            strSql.Append(" FROM wx_hb_imggroup ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from wx_hb_imggroup T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "wx_hb_imggroup";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select * from wx_hb_imggroup p");
            strSql.Append(" where " + strWhere);
            if (category_id > 0)
            {
                strSql.Append(" and hid =" + category_id);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wx_hb_imggroup set " + strValue);
            strSql.Append(" where id=" + id);

...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_dzpUsersTemp
	{
		...
		public MxWeiXinPF.Model.wx_dzpUsersTemp GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_dzpUsersTemp model=new MxWeiXinPF.Model.wx_dzpUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_dzpUsersTemp DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_dzpUsersTemp model=new MxWeiXinPF.Model.wx_dzpUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_dzpUsersTemp getModelByAidOpenid(int actId, string openid)
        {

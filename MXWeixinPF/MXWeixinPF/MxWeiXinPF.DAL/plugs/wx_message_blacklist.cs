...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_message_blacklist
	{
        ...
        public MxWeiXinPF.Model.wx_message_blacklist GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_message_blacklist model = new MxWeiXinPF.Model.wx_message_blacklist();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_message_blacklist DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_message_blacklist model = new MxWeiXinPF.Model.wx_message_blacklist();
            if (row != null)
            {

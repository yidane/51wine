...
{
	/// <summary>
	/// 数据访问类:wx_sttAwardItem
	/// </summary>
	public partial class wx_sttAwardItem
	{
		public wx_sttAwardItem()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_sttAwardItem"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_sttAwardItem");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_sttAwardItem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_sttAwardItem(");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@jxName", SqlDbType.VarChar,100),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_sttAwardItem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_sttAwardItem set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_sttAwardItem ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_sttAwardItem GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,actId,jxName,jpName,jpNum,jpRealNum,sort_id,createDate from wx_sttAwardItem ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			MxWeiXinPF.Model.wx_sttAwardItem model=new MxWeiXinPF.Model.wx_sttAwardItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_sttAwardItem DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_sttAwardItem model=new MxWeiXinPF.Model.wx_sttAwardItem();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_sttAwardItem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_sttAwardItem T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_sttAwardItem";

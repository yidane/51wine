...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_shoppic
	{
		...
		public MxWeiXinPF.Model.wx_diancai_shoppic GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_shoppic model=new MxWeiXinPF.Model.wx_diancai_shoppic();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_shoppic DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_shoppic model=new MxWeiXinPF.Model.wx_diancai_shoppic();
			if (row != null)
			{

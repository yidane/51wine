...
{
	/// <summary>
	/// 数据访问类:wx_hotel_form_control
	/// </summary>
	public partial class wx_hotel_form_control
	{
		public wx_hotel_form_control()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_hotel_form_control"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_hotel_form_control");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_hotel_form_control model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_hotel_form_control(");
			strSql.Append("hotelId,cName,cType,minLength,maxLength,defaultValue,isBiTian,seq,createDate,remark,extInt,extStr,isSys,sysControlerType)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_hotel_form_control model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_hotel_form_control set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_hotel_form_control ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_hotel_form_control GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,hotelId,cName,cType,minLength,maxLength,defaultValue,isBiTian,seq,createDate,remark,extInt,extStr,isSys,sysControlerType from wx_hotel_form_control ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			MxWeiXinPF.Model.wx_hotel_form_control model=new MxWeiXinPF.Model.wx_hotel_form_control();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_hotel_form_control DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_hotel_form_control model=new MxWeiXinPF.Model.wx_hotel_form_control();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,hotelId,cName,cType,minLength,maxLength,defaultValue,isBiTian,seq,createDate,remark,extInt,extStr,isSys,sysControlerType ");
			strSql.Append(" FROM wx_hotel_form_control ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,hotelId,cName,cType,minLength,maxLength,defaultValue,isBiTian,seq,createDate,remark,extInt,extStr,isSys,sysControlerType ");
			strSql.Append(" FROM wx_hotel_form_control ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_hotel_form_control T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_hotel_form_control";

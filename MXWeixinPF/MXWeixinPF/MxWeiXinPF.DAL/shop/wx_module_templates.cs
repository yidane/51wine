...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_module_templates
	{
		...
		public MxWeiXinPF.Model.wx_module_templates GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_module_templates model=new MxWeiXinPF.Model.wx_module_templates();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_module_templates DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_module_templates model=new MxWeiXinPF.Model.wx_module_templates();
			if (row != null)
			{

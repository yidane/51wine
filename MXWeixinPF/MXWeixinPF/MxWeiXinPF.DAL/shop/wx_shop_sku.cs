...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_shop_sku
	{
		...
		public MxWeiXinPF.Model.wx_shop_sku GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_shop_sku model=new MxWeiXinPF.Model.wx_shop_sku();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_shop_sku DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_shop_sku model=new MxWeiXinPF.Model.wx_shop_sku();
			if (row != null)
			{
        ...
        /// 得到商品的配件列表
        /// </summary>
        public List<MxWeiXinPF.Model.wx_shop_sku> GetpSkuModelList(int productId)
        {
            List<MxWeiXinPF.Model.wx_shop_sku> pStuList = new List<Model.wx_shop_sku>();

...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_shop_catalog_attribute
	{
		...
		public MxWeiXinPF.Model.wx_shop_catalog_attribute GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_shop_catalog_attribute model=new MxWeiXinPF.Model.wx_shop_catalog_attribute();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_shop_catalog_attribute DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_shop_catalog_attribute model=new MxWeiXinPF.Model.wx_shop_catalog_attribute();
			if (row != null)
			{

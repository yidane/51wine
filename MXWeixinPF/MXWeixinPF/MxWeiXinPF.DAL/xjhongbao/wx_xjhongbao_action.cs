...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_xjhongbao_action
	{
        ...
        public MxWeiXinPF.Model.wx_xjhongbao_action GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_xjhongbao_action model = new MxWeiXinPF.Model.wx_xjhongbao_action();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_xjhongbao_action DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_xjhongbao_action model = new MxWeiXinPF.Model.wx_xjhongbao_action();
            if (row != null)
            {

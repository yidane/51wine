...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_xjhongbao_lqinfo
	{
        ...
        public MxWeiXinPF.Model.wx_xjhongbao_lqinfo GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_xjhongbao_lqinfo model = new MxWeiXinPF.Model.wx_xjhongbao_lqinfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_xjhongbao_lqinfo DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_xjhongbao_lqinfo model = new MxWeiXinPF.Model.wx_xjhongbao_lqinfo();
            if (row != null)
            {

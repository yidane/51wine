...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_logs
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_logs"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_logs");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_logs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_logs(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_logs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_logs set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_logs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_logs GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,wid,modelName,remark,logsType,logsTypeName,createDate,logsContent,logsTitle,funName,createPerson,extInt,extStr,extStr2,extStr3,flg,flg2,flg3,flgInt,flgDate from wx_logs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			MxWeiXinPF.Model.wx_logs model=new MxWeiXinPF.Model.wx_logs();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_logs DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_logs model=new MxWeiXinPF.Model.wx_logs();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_logs T ");
        ...
        public bool ExistsFlg(string flg)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from wx_logs");
            strSql.Append(" where flg=@flg");
            SqlParameter[] parameters = {
					new SqlParameter("@flg", SqlDbType.VarChar,500)
			};
            parameters[0].Value = flg;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from wx_logs ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where  " + strWhere);
            }

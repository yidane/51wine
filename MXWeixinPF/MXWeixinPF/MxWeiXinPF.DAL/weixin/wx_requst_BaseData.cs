...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_requst_BaseData
	{
		...
		public MxWeiXinPF.Model.wx_requst_BaseData GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_requst_BaseData model=new MxWeiXinPF.Model.wx_requst_BaseData();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_requst_BaseData DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_requst_BaseData model=new MxWeiXinPF.Model.wx_requst_BaseData();
			if (row != null)
			{

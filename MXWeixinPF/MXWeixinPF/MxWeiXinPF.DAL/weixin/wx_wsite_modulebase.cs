...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_wsite_modulebase
	{
		...
		public MxWeiXinPF.Model.wx_wsite_modulebase GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_wsite_modulebase model=new MxWeiXinPF.Model.wx_wsite_modulebase();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_wsite_modulebase DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_wsite_modulebase model=new MxWeiXinPF.Model.wx_wsite_modulebase();
			if (row != null)
			{

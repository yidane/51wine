...
namespace MxWeiXinPF.DAL
{
    ...
    public partial class wx_requestRule
    {
        ...
        public MxWeiXinPF.Model.wx_requestRule GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_requestRule model = new MxWeiXinPF.Model.wx_requestRule();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_requestRule DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_requestRule model = new MxWeiXinPF.Model.wx_requestRule();
            if (row != null)
            {
        ...
        public MxWeiXinPF.Model.wx_requestRule GetSubscricModel(int wid)
        {
        ...
        /// <returns></returns>
        public MxWeiXinPF.Model.wx_requestRule GetTop1Model(int wid, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,wId,uId,ruleName,reqKeywords,reqestType,responseType,isDefault,modelFunctionName,modelFunctionId,seq,createDate,agentUrl,agentToken,isLikeSearch,extInt,extInt2,extStr,extStr2,extStr3,extStr4 from wx_requestRule ");

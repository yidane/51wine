...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_templates_wcode
	{
		...
		public MxWeiXinPF.Model.wx_templates_wcode GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_templates_wcode model=new MxWeiXinPF.Model.wx_templates_wcode();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_templates_wcode DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_templates_wcode model=new MxWeiXinPF.Model.wx_templates_wcode();
			if (row != null)
			{

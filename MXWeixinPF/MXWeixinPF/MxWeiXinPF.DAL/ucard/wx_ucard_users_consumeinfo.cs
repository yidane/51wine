...
namespace MxWeiXinPF.DAL
{
    ...
    public partial class wx_ucard_users_consumeinfo
    {
        ...
        public MxWeiXinPF.Model.wx_ucard_users_consumeinfo GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_ucard_users_consumeinfo model = new MxWeiXinPF.Model.wx_ucard_users_consumeinfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_ucard_users_consumeinfo DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_ucard_users_consumeinfo model = new MxWeiXinPF.Model.wx_ucard_users_consumeinfo();
            if (row != null)
            {

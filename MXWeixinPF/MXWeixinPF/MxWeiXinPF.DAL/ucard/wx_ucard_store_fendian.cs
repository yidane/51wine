...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_ucard_store_fendian
	{
		...
		public MxWeiXinPF.Model.wx_ucard_store_fendian GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_ucard_store_fendian model=new MxWeiXinPF.Model.wx_ucard_store_fendian();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_ucard_store_fendian DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_ucard_store_fendian model=new MxWeiXinPF.Model.wx_ucard_store_fendian();
			if (row != null)
			{

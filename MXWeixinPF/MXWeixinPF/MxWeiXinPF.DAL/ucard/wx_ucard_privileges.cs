...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_ucard_privileges
	{
        ...
        public MxWeiXinPF.Model.wx_ucard_privileges GetModel(int id)
        {
            ...
            MxWeiXinPF.Model.wx_ucard_privileges model = new MxWeiXinPF.Model.wx_ucard_privileges();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_ucard_privileges DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_ucard_privileges model = new MxWeiXinPF.Model.wx_ucard_privileges();
            if (row != null)
            {

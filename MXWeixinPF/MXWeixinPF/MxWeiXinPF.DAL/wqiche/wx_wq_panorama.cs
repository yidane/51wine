...
{
	/// <summary>
	/// 数据访问类:wx_wq_panorama
	/// </summary>
	public partial class wx_wq_panorama
	{
		public wx_wq_panorama()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "wx_wq_panorama"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from wx_wq_panorama");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_wq_panorama model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_wq_panorama(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_wq_panorama model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_wq_panorama set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_wq_panorama ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_wq_panorama GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,wid,fid,pri_front,pic_right,pic_behind,pic_left,pic_top,pic_bottom,pic_yulan,remark,seq,createDate,jdname from wx_wq_panorama ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			MxWeiXinPF.Model.wx_wq_panorama model=new MxWeiXinPF.Model.wx_wq_panorama();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_wq_panorama DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_wq_panorama model=new MxWeiXinPF.Model.wx_wq_panorama();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_wq_panorama ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_wq_panorama T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_wq_panorama";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select a.*  from wx_wq_panorama a ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where  " + strWhere);
            }

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_shop_catalog_attribute
	{
		...
		public WeiXinPF.Model.wx_shop_catalog_attribute GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_shop_catalog_attribute model=new WeiXinPF.Model.wx_shop_catalog_attribute();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_shop_catalog_attribute DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_shop_catalog_attribute model=new WeiXinPF.Model.wx_shop_catalog_attribute();
			if (row != null)
			{

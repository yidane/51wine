...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_shop_sku
	{
		...
		public WeiXinPF.Model.wx_shop_sku GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_shop_sku model=new WeiXinPF.Model.wx_shop_sku();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_shop_sku DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_shop_sku model=new WeiXinPF.Model.wx_shop_sku();
			if (row != null)
			{
        ...
        /// 得到商品的配件列表
        /// </summary>
        public List<WeiXinPF.Model.wx_shop_sku> GetpSkuModelList(int productId)
        {
            List<WeiXinPF.Model.wx_shop_sku> pStuList = new List<Model.wx_shop_sku>();

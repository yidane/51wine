...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_shop_product
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_shop_product DataRowToModel(DataRow row)
		{
        ...
        public DataSet GetList(int wid,int topNum,string where)
        {
            ...
            strSql.Append(" link_url='',(select top 1 original_path from dbo.wx_shop_albums where  productId=p.id) as productpic,* from wx_shop_product p ");

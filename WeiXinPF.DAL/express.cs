...
namespace WeiXinPF.DAL
{
    ...
    public partial class express
    {
        ...
        /// 获得物流信息
        /// </summary>
        public DataSet GetList(int wid,string openid,int id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from dbo.dt_express e left join dt_orders o on e.id=o.express_id where o.wid="+wid+" and o.openid="+"'"+openid+"'"+" and o.id="+id+"");
              return DbHelperSQL.Query(strSql.ToString());
        }

...
namespace WeiXinPF.DAL
{
    ...
    public partial class wx_PicStore
    {
        ...
        public WeiXinPF.Model.wx_PicStore GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_PicStore model = new WeiXinPF.Model.wx_PicStore();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_PicStore DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_PicStore model = new WeiXinPF.Model.wx_PicStore();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select distinct pictemplates,picType from wx_picstore");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM wx_picstore");
            strSql.Append(" where  picType=" + picType);

...
namespace WeiXinPF.DAL
{
    ...
    public partial class wx_requestRule
    {
        ...
        public WeiXinPF.Model.wx_requestRule GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_requestRule model = new WeiXinPF.Model.wx_requestRule();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_requestRule DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_requestRule model = new WeiXinPF.Model.wx_requestRule();
            if (row != null)
            {
        ...
        public WeiXinPF.Model.wx_requestRule GetSubscricModel(int wid)
        {
        ...
        /// <returns></returns>
        public WeiXinPF.Model.wx_requestRule GetTop1Model(int wid, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,wId,uId,ruleName,reqKeywords,reqestType,responseType,isDefault,modelFunctionName,modelFunctionId,seq,createDate,agentUrl,agentToken,isLikeSearch,extInt,extInt2,extStr,extStr2,extStr3,extStr4 from wx_requestRule ");

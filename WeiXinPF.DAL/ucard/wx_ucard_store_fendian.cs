...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_ucard_store_fendian
	{
		...
		public WeiXinPF.Model.wx_ucard_store_fendian GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_ucard_store_fendian model=new WeiXinPF.Model.wx_ucard_store_fendian();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_ucard_store_fendian DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_ucard_store_fendian model=new WeiXinPF.Model.wx_ucard_store_fendian();
			if (row != null)
			{

	...
	public partial class wx_ucard_store
	{
        ...
        public int Add(WeiXinPF.Model.wx_ucard_store model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@cardBrief", SqlDbType.VarChar,500),
        ...
        public WeiXinPF.Model.wx_ucard_store GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_ucard_store model = new WeiXinPF.Model.wx_ucard_store();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_ucard_store DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_ucard_store model = new WeiXinPF.Model.wx_ucard_store();
            if (row != null)
            {

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_blacklist
	{
        ...
        public WeiXinPF.Model.wx_diancai_blacklist GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_diancai_blacklist model = new WeiXinPF.Model.wx_diancai_blacklist();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_diancai_blacklist DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_diancai_blacklist model = new WeiXinPF.Model.wx_diancai_blacklist();
            if (row != null)
            {

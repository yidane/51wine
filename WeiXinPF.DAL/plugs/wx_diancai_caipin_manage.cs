...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_caipin_manage
	{
		...
		public WeiXinPF.Model.wx_diancai_caipin_manage GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_caipin_manage model=new WeiXinPF.Model.wx_diancai_caipin_manage();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_caipin_manage DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_caipin_manage model=new WeiXinPF.Model.wx_diancai_caipin_manage();
			if (row != null)
			{

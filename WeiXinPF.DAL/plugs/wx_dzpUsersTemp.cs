...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_dzpUsersTemp
	{
		...
		public WeiXinPF.Model.wx_dzpUsersTemp GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_dzpUsersTemp model=new WeiXinPF.Model.wx_dzpUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_dzpUsersTemp DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_dzpUsersTemp model=new WeiXinPF.Model.wx_dzpUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_dzpUsersTemp getModelByAidOpenid(int actId, string openid)
        {

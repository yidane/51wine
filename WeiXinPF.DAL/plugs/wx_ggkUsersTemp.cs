...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_ggkUsersTemp
	{
		...
		public WeiXinPF.Model.wx_ggkUsersTemp GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_ggkUsersTemp model=new WeiXinPF.Model.wx_ggkUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_ggkUsersTemp DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_ggkUsersTemp model=new WeiXinPF.Model.wx_ggkUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_ggkUsersTemp getModelByAidOpenid(int actId, string openid)
        {

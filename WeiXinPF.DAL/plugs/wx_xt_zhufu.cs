...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_xt_zhufu
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_xt_zhufu model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_xt_zhufu model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_xt_zhufu GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_xt_zhufu model=new WeiXinPF.Model.wx_xt_zhufu();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_xt_zhufu DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_xt_zhufu model=new WeiXinPF.Model.wx_xt_zhufu();
			if (row != null)
			{

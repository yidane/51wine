...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_form_result
	{
		...
		public WeiXinPF.Model.wx_diancai_form_result GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_form_result model=new WeiXinPF.Model.wx_diancai_form_result();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_form_result DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_form_result model=new WeiXinPF.Model.wx_diancai_form_result();
			if (row != null)
			{

...
namespace WeiXinPF.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(MXKeys.COOKIE_USER_NAME_REMEMBER, "WeiXinPF", -43200);
                Utils.WriteCookie(MXKeys.COOKIE_USER_PWD_REMEMBER, "WeiXinPF", -43200);
                Utils.WriteCookie("UserName", "WeiXinPF", -1);
                Utils.WriteCookie("Password", "WeiXinPF", -1);
                //自动登录,跳转URL

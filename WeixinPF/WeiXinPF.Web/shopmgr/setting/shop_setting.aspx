<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop_setting.aspx.cs" Inherits="WeiXinPF.Web.shopmgr.setting.shop_setting" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <!--/导航栏-->
         <div class="mytips">
            使用微商城前，请确保您的微信公众号为 <span class="red">申请成功了微信支付的服务号</span>！并且在“网页授权获取用户基本信息”里"授权回调页面域名"填写 <asp:Label ID="lblDemain" runat="server" Text="" CssClass="red"></asp:Label>
             <br />我们的平台请确保：
            【1】请在我的公众账号编辑界面添加正确的 <span class="red">AppId</span> 和 <span class="red">AppSecret</span>
             <br />【2】“商城设置”完后，请添加微信支付
             <br />【3】把“ 微支付配置信息（开发配置）”里的信息填写到微信公众号官方网站里
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">微支付配置信息（开发配置）</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="upload-box upload-img"></div>
                      <span class="Validform_checktip">宽度75px,高度30px/span>
                </dd>
            </dl>
            <dl>
                <dt>背景图片</dt>
        ...
        <div class="tab-content" style="display: none;">
            <dl>
                <dt style="color:red;">注：</dt>
                <dd style="color:red;">
                    官方网站网址：https://mp.weixin.qq.com
                    登陆后，右侧点击“微信支付”-->开发配置--->支付配置--->修改 页面添加以下信息
                </dd>
            </dl>
            <dl>
                <dt>接口形式 </dt>
            ...
            <dl>
                ...
                <span class="Validform_checktip">（也作为测试目录）</span>
                     </dd>
            </dl>
            <dl>
                <dt>支付请求实例 </dt>

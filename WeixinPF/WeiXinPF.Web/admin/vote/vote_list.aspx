<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vote_list.aspx.cs" Inherits="WeiXinPF.Web.admin.vote.vote_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    ...
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="vote_character_add.aspx?action=<%=WeiXinPF.Common.MXEnums.ActionEnum.Add %>" id="itemAddButton"><i></i><span>发起文字投票</span></a></li>
                        <li><a class="icon-btn add" href="vote_picture_add.aspx?action=<%=WeiXinPF.Common.MXEnums.ActionEnum.Add %>" id="itemBlackButton"><i></i><span>发起图片投票</span></a></li>
                    ...
                    <div class="l-list">
                        <ul class="rule-single-select">
                            <li>
                                ...
                                <%#new WeiXinPF.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%>
                            </li>
                        </ul>
                    </div>

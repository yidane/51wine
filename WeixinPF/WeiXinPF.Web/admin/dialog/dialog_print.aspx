<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_print.aspx.cs" Inherits="WeiXinPF.Web.admin.dialog.dialog_print" %>
...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      <td>配送方式：<%=new WeiXinPF.BLL.express().GetTitle(model.express_id)%></td>

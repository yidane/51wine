<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editXitie.aspx.cs" Inherits="WeiXinPF.Web.admin.hunqing.editXitie" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>触发时的图片</dt>
                <dd>
                    <asp:Image ID="imgbeginPic" runat="server" ImageUrl="http://img.uweixin.cn/xitie/xite_fengmian.png" Style="max-height: 80px;" />
                    <asp:TextBox ID="txtImgUrl" runat="server" CssClass="input normal upload-path"  Text="http://img.uweixin.cn/xitie/xite_fengmian.png" />
            ...
            <dl>
                <dt>开场动画的图片</dt>
                <dd>
                    <asp:Image ID="imgKcdh" runat="server" ImageUrl="http://img.uweixin.cn/xitie/xitie_kcdh.jpg" Style="max-height: 160px;" /><br />

                    <asp:TextBox ID="txtKcdh" runat="server" CssClass="input normal upload-path"  Text="http://img.uweixin.cn/xitie/xitie_kcdh.jpg" />
                    <div class="upload-box upload-img"></div>
            ...
            <dl>
                <dt>缩略图</dt>
                <dd>
                    <asp:Image ID="imgdonghuaSlt" runat="server" ImageUrl="http://img.uweixin.cn/xitie/xitie_slt.jpg" Style="max-height: 40px;" /><br />

                    <asp:TextBox ID="txtdonghuaSlt" runat="server" CssClass="input normal upload-path"  Text="http://img.uweixin.cn/xitie/xitie_slt.jpg" />
                    <div class="upload-box upload-img"></div>

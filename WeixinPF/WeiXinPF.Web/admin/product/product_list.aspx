<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_list.aspx.cs" Inherits="WeiXinPF.Web.admin.product.product_list" %>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#new WeiXinPF.BLL.wx_product_type().GetTitle(Convert.ToInt32(Eval("typeId")))%></td>
                    <td>
                        <%# Eval("url") %>
                    </td>

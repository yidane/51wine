...
<body class="mainbody">
  ...
  <div class="location">
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                     <ul class="icon-list">
                     <li><a class="icon-btn add" href="hotel_room_info.aspx?action=<%=WeiXinPF.Common.MXEnums.ActionEnum.Add %>&type=add&hotelid=<%=hotelid %>"  id="itemAddButton"><i></i><span>新增房间类型</span></a></li>                       

...
namespace WeiXinPF.Web.admin.scenic
{
    public partial class scenic_detail_edit : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _scenicId = MXRequest.GetQueryInt("scenicId");
            if (!IsPostBack)
            {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (_action == MXEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改信息成功！", Utils.CombUrlTxt("scenic_detail_list.aspx", "scenicId={0}", _scenicId.ToString()), "Success");
            }
            else //添加
            {
                if (!DoAdd())
                ...
                JscriptMsg("添加信息成功！", Utils.CombUrlTxt("scenic_detail_list.aspx", "scenicId={0}", _scenicId.ToString()), "Success");
            }
        }
    }
}
...
namespace WeiXinPF.Web.admin.albums
{
    public partial class photolist : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("photolist.aspx", "id={0}&keywords={1}&page={2}",aid.ToString(), this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("photolist.aspx", "id={0}&keywords={1}",aid.ToString(), txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("photolist.aspx", "id={0}&keywords={1}",aid.ToString(), this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("photolist.aspx", "id={0}&keywords={1}",aid.ToString(), this.keywords), "Success");
        }

...
{
    public partial class ggkEdit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            #region 赋值
            Model.wx_ggkActionInfo ggk = new Model.wx_ggkActionInfo();
            ...
            {  //新增
                ...
                AddAdminLog(MXEnums.ActionEnum.Add.ToString(), "添加刮刮卡活动，主键为"+id); //记录日志
            ...
            {   //修改
                ...
                EditAwardItem(id);
                //3 修改回复规则表
               IList< Model.wx_requestRule> rlist = rBll.GetModelList("modelFunctionName = '刮刮卡' and modelFunctionId="+id);
               ...
               AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "修改刮刮卡活动，主键为" + id); //记录日志

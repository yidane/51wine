<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop_admin_edit.aspx.cs" Inherits="WeiXinPF.Web.admin.diancai.shop_admin_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <%} %>
            <a href="shop_admin_list.aspx?shopid=<%=shopid %>"><i></i><span>管理员列表</span></a>
            <i class="arrow"></i>
            <span>编辑管理员</span>
        </div>

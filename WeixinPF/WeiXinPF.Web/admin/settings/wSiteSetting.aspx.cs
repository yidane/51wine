...
namespace WeiXinPF.Web.admin.settings
{
    ...
    {
        WeiXinPF.BLL.wx_wsite_setting bll = new WeiXinPF.BLL.wx_wsite_setting();
        ...
        private void ShowInfo()
        {
            ...
            IList<WeiXinPF.Model.wx_wsite_setting> modellist = bll.GetModelList("wId="+weixin.id);
            if (modellist == null || modellist.Count <= 0)
            {
                return;
            }
            WeiXinPF.Model.wx_wsite_setting model = modellist[0];

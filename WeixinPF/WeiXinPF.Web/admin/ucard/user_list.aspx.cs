...
namespace WeiXinPF.Web.admin.ucard
{
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("ucard_hy", MXEnums.ActionEnum.View.ToString()); //检查权限
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("user_list.aspx", "id={0}&keywords={1}&page={2}", sid.ToString(), this.keywords, "__id__");
        ...
        {
            ChkAdminLevel("ucard_hy", MXEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;

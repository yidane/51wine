<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeiXinPF.Web.weixin.ucard.index" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="menu_header">
            <div class="menu_topbar">
                ...
                <a class="head_btn_right" href="javascript:void(0)">
        ...
        <div class="cardexplain">
            ...
            <ul class="round" id="powerandgift">
                ...
                <asp:Literal ID="litUserinfo" runat="server" EnableViewState="false"></asp:Literal>
            ...
            <ul class="round">
                <li class="addr">
                    <a href="" runat="server" id="aAddr">
                        <span>地址:
                            <asp:Literal ID="litAddr" runat="server" EnableViewState="false"></asp:Literal></span>

                    </a>

                </li>
                <li class="tel"><a href="" runat="server" id="aTel"><span>电话:
                    <asp:Literal ID="litTel" runat="server" EnableViewState="false"></asp:Literal></span></a></li>
            </ul>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeiXinPF.Web.weixin.yuyue.index" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input id="picUpload" name="picUpload" type="file" accept="image/jpeg, image/jpg, image/png"  onchange="my.changeImg(this, event, {base_url:'http://img.uweixin.cn/'});"/>
                                    <br />
                                    <img src="#" id="img_show" style="max-width:100px; max-height:80px;">
                                </td>
                            </tr>
                        </tbody>
                    </table>

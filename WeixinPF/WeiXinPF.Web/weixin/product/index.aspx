<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeiXinPF.Web.weixin.product.index" %>
                            ...
                            <li>
                                ...
                                <a href='<%#getDetailUrl(Eval("id"),Eval("typeId")) %> ' id="aDetail" class="tbox">
                                    ...
                                    <div>
                                      ...
                                      <p style="padding-right:25px;padding-top:5px;"> <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("pSubject") %>'></asp:Literal> </p>

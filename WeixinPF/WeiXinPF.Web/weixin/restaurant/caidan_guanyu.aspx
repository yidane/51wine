<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caidan_guanyu.aspx.cs" Inherits="WeiXinPF.Web.weixin.restaurant.caidan_guanyu" %>
...
<div class="footermenu">
        <ul>
            <li>
                <a class="active"  href="caidan_guanyu.aspx?shopid=<%=shopid %>&openid=<%=openid %>">

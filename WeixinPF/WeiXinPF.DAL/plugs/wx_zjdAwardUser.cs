...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_zjdAwardUser
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_zjdAwardUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_zjdAwardUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_zjdAwardUser GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_zjdAwardUser model=new WeiXinPF.Model.wx_zjdAwardUser();
        ...
        public WeiXinPF.Model.wx_zjdAwardUser DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_zjdAwardUser model = new WeiXinPF.Model.wx_zjdAwardUser();
            if (row != null)
            {
        ...
        public WeiXinPF.Model.wx_zjdAwardUser getZJinfoByOpenid(int actId, string openid)
        {
            ...
            WeiXinPF.Model.wx_dzpAwardUser model = new WeiXinPF.Model.wx_dzpAwardUser();
            DataSet ds = DbHelperSQL.Query(strSql.ToString(), parameters);
            if (ds.Tables[0].Rows.Count > 0)
            {
                return DataRowToModel(ds.Tables[0].Rows[0]);

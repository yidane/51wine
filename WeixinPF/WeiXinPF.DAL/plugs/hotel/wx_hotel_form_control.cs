...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_hotel_form_control
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_hotel_form_control model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_hotel_form_control model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_hotel_form_control GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_hotel_form_control model=new WeiXinPF.Model.wx_hotel_form_control();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_hotel_form_control DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_hotel_form_control model=new WeiXinPF.Model.wx_hotel_form_control();
			if (row != null)
			{

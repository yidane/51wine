...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_sttAwardItem
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_sttAwardItem model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_sttAwardItem model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_sttAwardItem GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_sttAwardItem model=new WeiXinPF.Model.wx_sttAwardItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_sttAwardItem DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_sttAwardItem model=new WeiXinPF.Model.wx_sttAwardItem();
			if (row != null)
			{

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_member
	{
		...
		public WeiXinPF.Model.wx_diancai_member GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_member model=new WeiXinPF.Model.wx_diancai_member();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_member DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_member model=new WeiXinPF.Model.wx_diancai_member();
			if (row != null)
			{
        ...
        public bool Update(string  openid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wx_diancai_member set successDingdan=successDingdan+1  ");
        ...
        public bool Updatefail(string openid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wx_diancai_member set failDingdan=failDingdan+1  ");
            strSql.Append(" where openid='" + openid + "'");
        ...
        public WeiXinPF.Model.wx_diancai_member GetModel(int shopid,string openid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,shopid,Name,openid,createDate,weixinName,memberName,menberTel,memberAddress,successDingdan,failDingdan,cancelDingdan,status,zongjifen,zongcje from wx_diancai_member ");
            strSql.Append(" where shopid=@shopid and openid=@openid ");
            SqlParameter[] parameters = {
					new SqlParameter("@shopid", SqlDbType.Int,4),

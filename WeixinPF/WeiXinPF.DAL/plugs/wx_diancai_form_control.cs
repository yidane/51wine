...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_form_control
	{
		...
		public WeiXinPF.Model.wx_diancai_form_control GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_form_control model=new WeiXinPF.Model.wx_diancai_form_control();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_form_control DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_form_control model=new WeiXinPF.Model.wx_diancai_form_control();
			if (row != null)
			{

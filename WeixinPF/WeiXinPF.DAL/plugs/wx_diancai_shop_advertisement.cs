...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_shop_advertisement
	{
		...
		public WeiXinPF.Model.wx_diancai_shop_advertisement GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_shop_advertisement model=new WeiXinPF.Model.wx_diancai_shop_advertisement();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_shop_advertisement DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_shop_advertisement model=new WeiXinPF.Model.wx_diancai_shop_advertisement();
			if (row != null)
			{
        ...
        public bool DeleteByShopId(int shopId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from wx_diancai_shop_advertisement ");
            strSql.Append(" where setupid=@setupid");
            SqlParameter[] parameters = {
					new SqlParameter("@setupid", SqlDbType.Int,4)
			};

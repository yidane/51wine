...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_wq_panorama
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_wq_panorama model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_wq_panorama model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_wq_panorama GetModel(int Id)
		{
			...
			WeiXinPF.Model.wx_wq_panorama model=new WeiXinPF.Model.wx_wq_panorama();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_wq_panorama DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_wq_panorama model=new WeiXinPF.Model.wx_wq_panorama();
			if (row != null)
			{

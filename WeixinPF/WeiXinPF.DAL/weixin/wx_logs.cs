...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_logs
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_logs model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_logs model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_logs GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_logs model=new WeiXinPF.Model.wx_logs();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_logs DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_logs model=new WeiXinPF.Model.wx_logs();
			if (row != null)
			{

...
namespace WeiXinPF.DAL
{
    ...
    public partial class wx_ucard_users_consumeinfo
    {
        ...
        public WeiXinPF.Model.wx_ucard_users_consumeinfo GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_ucard_users_consumeinfo model = new WeiXinPF.Model.wx_ucard_users_consumeinfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_ucard_users_consumeinfo DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_ucard_users_consumeinfo model = new WeiXinPF.Model.wx_ucard_users_consumeinfo();
            if (row != null)
            {

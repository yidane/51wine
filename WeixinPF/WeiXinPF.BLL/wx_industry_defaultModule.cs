...
namespace WeiXinPF.BLL
{
    ...
    {
        private readonly WeiXinPF.DAL.wx_industry_defaultModule dal = new WeiXinPF.DAL.wx_industry_defaultModule();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WeiXinPF.Model.wx_industry_defaultModule model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WeiXinPF.Model.wx_industry_defaultModule model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_industry_defaultModule GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_industry_defaultModule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_industry_defaultModule> DataTableToList(DataTable dt)
        {
            List<WeiXinPF.Model.wx_industry_defaultModule> modelList = new List<WeiXinPF.Model.wx_industry_defaultModule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WeiXinPF.Model.wx_industry_defaultModule model;

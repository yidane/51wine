...
namespace WeiXinPF.BLL
{
	...
	public partial class channel_category
	{
        ...
        public bool UpdateSort(int id, int sort_id)
        {
            ...
            if (new BLL.navigation().UpdateField("channel_" + build_path, "sort_id=" + sort_id))
            {
		...
		public bool Update(Model.channel_category model)
		{
            ...
            if (dal.Update(model))
            {
                ...
                //修改对应的导航
                new BLL.navigation().Update("channel_" + oldModel.build_path, "channel_" + model.build_path, model.title, model.sort_id);
        ...
        {
            List<Model.channel_category> modelList = new List<WeiXinPF.Model.channel_category>();
            ...
            if (rowsCount > 0)
            {
                ...
                {
                    model = new WeiXinPF.Model.channel_category();

...
namespace WeiXinPF.BLL
{
    ...
    {
        private readonly WeiXinPF.DAL.wx_crm_setting dal = new WeiXinPF.DAL.wx_crm_setting();
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_crm_setting> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_crm_setting> DataTableToList(DataTable dt)
        {
            List<WeiXinPF.Model.wx_crm_setting> modelList = new List<WeiXinPF.Model.wx_crm_setting>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                WeiXinPF.Model.wx_crm_setting model;

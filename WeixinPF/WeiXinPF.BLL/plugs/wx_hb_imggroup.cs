...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_hb_imggroup dal=new WeiXinPF.DAL.wx_hb_imggroup();
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_hb_imggroup> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_hb_imggroup> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_hb_imggroup> modelList = new List<WeiXinPF.Model.wx_hb_imggroup>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_hb_imggroup model;

...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_hotel_room dal=new WeiXinPF.DAL.wx_hotel_room();
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_hotel_room> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_hotel_room> modelList = new List<WeiXinPF.Model.wx_hotel_room>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_hotel_room model;

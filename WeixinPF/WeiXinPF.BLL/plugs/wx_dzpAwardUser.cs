...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_dzpAwardUser dal=new WeiXinPF.DAL.wx_dzpAwardUser();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_dzpAwardUser model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_dzpAwardUser model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_dzpAwardUser GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_dzpAwardUser> GetModelList(string strWhere)
		{
		...
		public List<WeiXinPF.Model.wx_dzpAwardUser> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_dzpAwardUser model;
        ...
        {
            WeiXinPF.Model.wx_dzpAwardUser auser = new Model.wx_dzpAwardUser();
            auser.actId = aid;
        ...
        /// 获得中奖的数据列表
        /// </summary>
        public List<WeiXinPF.Model.wx_dzpAwardUser> getHasZJList(int aid)
        {

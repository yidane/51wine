...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_lbs_shopInfo dal=new WeiXinPF.DAL.wx_lbs_shopInfo();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_lbs_shopInfo model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_lbs_shopInfo model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_lbs_shopInfo GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_lbs_shopInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_lbs_shopInfo> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_lbs_shopInfo> modelList = new List<WeiXinPF.Model.wx_lbs_shopInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_lbs_shopInfo model;

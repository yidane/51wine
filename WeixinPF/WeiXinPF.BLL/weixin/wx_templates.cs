...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_templates dal=new WeiXinPF.DAL.wx_templates();
		public wx_templates()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(WeiXinPF.Model.wx_templates model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_templates model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_templates GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_templates> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_templates> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_templates> modelList = new List<WeiXinPF.Model.wx_templates>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_templates model;
        ...
        /// 通过wid获得微帐号对应的列表模版名称
        /// </summary>
        public string GetLieBiaoTemplatesFileNameByWid(int wid)
        {

            return dal.GetLieBiaoTemplatesFileNameByWid(wid);
        }

...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_payment_wxpay dal=new WeiXinPF.DAL.wx_payment_wxpay();
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_payment_wxpay> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_payment_wxpay> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_payment_wxpay> modelList = new List<WeiXinPF.Model.wx_payment_wxpay>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_payment_wxpay model;

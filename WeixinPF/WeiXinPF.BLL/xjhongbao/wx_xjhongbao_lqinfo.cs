...
namespace WeiXinPF.BLL
{
	...
	{
		private readonly WeiXinPF.DAL.wx_xjhongbao_lqinfo dal=new WeiXinPF.DAL.wx_xjhongbao_lqinfo();
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_xjhongbao_lqinfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WeiXinPF.Model.wx_xjhongbao_lqinfo> DataTableToList(DataTable dt)
		{
			List<WeiXinPF.Model.wx_xjhongbao_lqinfo> modelList = new List<WeiXinPF.Model.wx_xjhongbao_lqinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WeiXinPF.Model.wx_xjhongbao_lqinfo model;

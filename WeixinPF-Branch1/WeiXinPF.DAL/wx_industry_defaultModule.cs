...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_industry_defaultModule
	{
		...
		public WeiXinPF.Model.wx_industry_defaultModule GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_industry_defaultModule model=new WeiXinPF.Model.wx_industry_defaultModule();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_industry_defaultModule DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_industry_defaultModule model=new WeiXinPF.Model.wx_industry_defaultModule();
			if (row != null)
			{

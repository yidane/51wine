...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_message_blacklist
	{
        ...
        public WeiXinPF.Model.wx_message_blacklist GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_message_blacklist model = new WeiXinPF.Model.wx_message_blacklist();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_message_blacklist DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_message_blacklist model = new WeiXinPF.Model.wx_message_blacklist();
            if (row != null)
            {

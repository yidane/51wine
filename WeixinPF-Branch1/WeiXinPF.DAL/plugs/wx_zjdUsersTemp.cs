...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_zjdUsersTemp
	{
		...
		public WeiXinPF.Model.wx_zjdUsersTemp GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_zjdUsersTemp model=new WeiXinPF.Model.wx_zjdUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_zjdUsersTemp DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_zjdUsersTemp model=new WeiXinPF.Model.wx_zjdUsersTemp();
			if (row != null)
			{
        ...
        public WeiXinPF.Model.wx_zjdUsersTemp getModelByAidOpenid(int actId, string openid)
        {
        ...
        public WeiXinPF.Model.wx_zjdUsersTemp DataRowToModell(DataRow row)
        {
            WeiXinPF.Model.wx_zjdUsersTemp model = new WeiXinPF.Model.wx_zjdUsersTemp();
            if (row != null)
            {

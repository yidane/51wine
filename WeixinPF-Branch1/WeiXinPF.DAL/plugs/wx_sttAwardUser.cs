...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_sttAwardUser
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WeiXinPF.Model.wx_sttAwardUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WeiXinPF.Model.wx_sttAwardUser model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_sttAwardUser GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_sttAwardUser model=new WeiXinPF.Model.wx_sttAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_sttAwardUser DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_sttAwardUser model=new WeiXinPF.Model.wx_sttAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public WeiXinPF.Model.wx_sttAwardUser getZJinfoByOpenid(int actId, string openid)
        {

...
namespace WeiXinPF.DAL
{
    ...
    public partial class wx_diancai_dingdan_caiping
    {
        ...
        public WeiXinPF.Model.wx_diancai_dingdan_caiping GetModel(int id)
        {
            ...
            WeiXinPF.Model.wx_diancai_dingdan_caiping model = new WeiXinPF.Model.wx_diancai_dingdan_caiping();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_diancai_dingdan_caiping DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_diancai_dingdan_caiping model = new WeiXinPF.Model.wx_diancai_dingdan_caiping();
            if (row != null)
            {

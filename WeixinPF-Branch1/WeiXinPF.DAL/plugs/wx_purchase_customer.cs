...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_purchase_customer
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_purchase_customer GetModel(int Id)
        {
            ...
            WeiXinPF.Model.wx_purchase_customer model = new WeiXinPF.Model.wx_purchase_customer();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WeiXinPF.Model.wx_purchase_customer DataRowToModel(DataRow row)
        {
            WeiXinPF.Model.wx_purchase_customer model = new WeiXinPF.Model.wx_purchase_customer();
            if (row != null)
            {

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_sjb_richeng
	{
		...
		public WeiXinPF.Model.wx_sjb_richeng GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_sjb_richeng model=new WeiXinPF.Model.wx_sjb_richeng();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_sjb_richeng DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_sjb_richeng model=new WeiXinPF.Model.wx_sjb_richeng();
			if (row != null)
			{
        ...
        public bool DeleteRiCheng(int id)
        {
            ...
            strSql.Append(" delete from wx_sjb_jcDetail where actId=" + id + ";");

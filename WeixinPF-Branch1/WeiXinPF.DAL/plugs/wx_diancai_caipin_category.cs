...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_caipin_category
	{
		...
		public WeiXinPF.Model.wx_diancai_caipin_category GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_caipin_category model=new WeiXinPF.Model.wx_diancai_caipin_category();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_caipin_category DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_caipin_category model=new WeiXinPF.Model.wx_diancai_caipin_category();
			if (row != null)
			{

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_diancai_shop_setup
	{
		...
		public WeiXinPF.Model.wx_diancai_shop_setup GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_diancai_shop_setup model=new WeiXinPF.Model.wx_diancai_shop_setup();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_diancai_shop_setup DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_diancai_shop_setup model=new WeiXinPF.Model.wx_diancai_shop_setup();
			if (row != null)
			{

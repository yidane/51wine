...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_ggkAwardUser
	{
		...
		public WeiXinPF.Model.wx_ggkAwardUser GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_ggkAwardUser model=new WeiXinPF.Model.wx_ggkAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_ggkAwardUser DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_ggkAwardUser model=new WeiXinPF.Model.wx_ggkAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public WeiXinPF.Model.wx_ggkAwardUser getZJinfoByOpenid(int actId, string openid)
        {

...
namespace WeiXinPF.DAL
{
	...
	public partial class wx_shop_productAttr_value
	{
		...
		public WeiXinPF.Model.wx_shop_productAttr_value GetModel(int id)
		{
			...
			WeiXinPF.Model.wx_shop_productAttr_value model=new WeiXinPF.Model.wx_shop_productAttr_value();
		...
		/// 得到一个对象实体
		/// </summary>
		public WeiXinPF.Model.wx_shop_productAttr_value DataRowToModel(DataRow row)
		{
			WeiXinPF.Model.wx_shop_productAttr_value model=new WeiXinPF.Model.wx_shop_productAttr_value();
			if (row != null)
			{
        ...
        /// 得到商品的属性列表(属性名称—属性值)
        /// </summary>
        public List<WeiXinPF.Model.wx_shop_productAttr_value> GetAttrModelList(int productId)
        {
             List<WeiXinPF.Model.wx_shop_productAttr_value> pAttrList = new List<Model.wx_shop_productAttr_value>();
            StringBuilder strSql = new StringBuilder();

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="photoEdit.aspx.cs" Inherits="WeiXinPF.Web.admin.photo.photoEdit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="photolist.aspx" class="back"><i></i><span>返回湖怪活动列表</span></a>
            <i class="arrow"></i>
            <span>编辑湖怪活动</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑湖怪活动内容</a></li>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    ...
                    <asp:TextBox ID="txtKW" runat="server" CssClass="input normal" datatype="*1-20" sucmsg=" " Text="湖怪" />
           ...
           <%-- <dl>
            ...
            <dl>
                <dt>活动名称</dt>
                <dd>
                    <asp:TextBox ID="txtactName" runat="server" CssClass="input normal" datatype="*1-50" sucmsg=" " Text="湖怪活动开始了" />
            ...
            <dl>
                <dt>湖怪话语</dt>
                <dd>
                    <textarea name="txtactContent" rows="2" cols="20" id="txtactContent" class="input" runat="server">亲，来合个影吧！</textarea>
                    <span class="Validform_checktip"></span>
                </dd>
            </dl>
        ...
        <div class="page-footer">
            <div class="btn-list">
                ...
                <a href="photolist.aspx"><span class="btn yellow">返回上一页</span></a>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_list.aspx.cs" Inherits="WeiXinPF.Web.admin.grouppurchase.group_list" %>
      ...
      <div class="mytips">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="group_base_add.aspx?action=<%=WeiXinPF.Common.MXEnums.ActionEnum.Add %>"  id="itemAddButton"><i></i><span>新增团购活动</span></a></li>

...
namespace WeiXinPF.Web.admin.article
{
    public partial class wx_article_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.prolistview = Utils.GetCookie("wx_article_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("articlemgr", MXEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("articlemgr", MXEnums.ActionEnum.Edit.ToString()); //检查权限
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("wx_article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            Utils.WriteCookie("wx_article_list_view", "Txt", 14400);
            Response.Redirect(Utils.CombUrlTxt("wx_article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", Utils.CombUrlTxt("wx_article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            ChkAdminLevel("articlemgr", MXEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "删除微信" + this.channel_name + "频道内容成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("wx_article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}
...
namespace WeiXinPF.Web.admin.picmgr
{
    public partial class picSelect : System.Web.UI.Page
    {
        ...
        WeiXinPF.BLL.wx_PicStore bll = new WeiXinPF.BLL.wx_PicStore();
        ...
        private void BindPic(int picType)
        {
            ...
            //    return;
            //}
            //WeiXinPF.Model.wx_PicStore p = new WeiXinPF.Model.wx_PicStore();

...
namespace WeiXinPF.Web.admin.settings
{
    public partial class templet_file_list : Web.UI.ManagePage
    {
        ...
        {
            skinName = MXRequest.GetQueryString("skin");
        ...
        {
            ChkAdminLevel("app_templet_list", MXEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除模板文件，模板:" + this.skinName);//记录日志

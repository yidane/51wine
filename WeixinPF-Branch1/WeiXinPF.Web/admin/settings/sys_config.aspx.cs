...
namespace WeiXinPF.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        private void BindWeiXinInfo()
        {
            string onlyWeiXinLook = BLL.wx_sysConfig.GetConfigValue("onlyweixinlook");
            if (onlyWeiXinLook.ToLower() == "true")
            {
                radOnlyWeixinLook.SelectedValue = "1";
            }
            else
            {
                radOnlyWeixinLook.SelectedValue = "0";
            }
        ...
        /// 编辑微信相关配置
        /// </summary>
        private void EditWeiXinInfo()
        {
            string onlyweixinlook = radOnlyWeixinLook.SelectedItem.Value;
            string value = "";
            if (onlyweixinlook == "1")
            {
                value = "true";
            ...
            BLL.wx_sysConfig.EditSysValue("onlyweixinlook",value);
        }

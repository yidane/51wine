...
namespace WeiXinPF.Web.admin.settings
{
    public partial class templet_file_edit : Web.UI.ManagePage
    {
        ...
        {
            pathName = MXRequest.GetQueryString("path");
            fileName = MXRequest.GetQueryString("filename");
        ...
        {
            ChkAdminLevel("app_templet_list", MXEnums.ActionEnum.Edit.ToString()); //检查权限
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "修改模板文件:" + this.fileName);//记录日志

...
namespace WeiXinPF.Web.admin.choujiang
{
    ...
    public partial class dzpAwardUser : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("dzpAwardUser.aspx" , "id={0}&keywords={1}&page={2}",MyCommFun.RequestInt("id").ToString(), this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dzpAwardUser.aspx", "id={0}&keywords={1}",MyCommFun.RequestInt("id").ToString(), txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("dzpAwardUser.aspx", "id={0}&keywords={1}",MyCommFun.RequestInt("id").ToString(), this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("dzpAwardUser.aspx", "id={0}&keywords={1}",MyCommFun.RequestInt("id").ToString(), this.keywords), "Success");
        }

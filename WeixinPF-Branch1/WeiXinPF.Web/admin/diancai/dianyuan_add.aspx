<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dianyuan_add.aspx.cs" Inherits="WeiXinPF.Web.admin.diancai.dianyuan_add" %>
      ...
      <div class="location">
            ...
            <a    href="#" class="home"><i></i><span>商户或门店列表</span></a>
              <i class="arrow"></i>
                ...
                <%} %> <span><a href="dianyuan_manage.aspx?shopid=<%=shopid %>" >店员信息管理</a></span>
            <i class="arrow"></i>            
            <span>店员信息管理</span>
        </div>

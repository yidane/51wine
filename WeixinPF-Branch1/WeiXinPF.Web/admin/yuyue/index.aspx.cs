...
namespace WeiXinPF.Web.admin.yuyue
{
    public partial class index : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            DataSet ds = yyBll.GetList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("yuyue_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("yuyue_page_size", _pagesize.ToString(), 14400);
                }
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除预约信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志

...
namespace WeiXinPF.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "WeiXinPF.Web.UI.Page.article";
                    break;
                case "category":
                    result = "WeiXinPF.Web.UI.Page.category";
                    break;
                case "list":
                    result = "WeiXinPF.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "WeiXinPF.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }

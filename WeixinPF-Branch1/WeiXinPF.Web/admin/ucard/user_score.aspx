<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_score.aspx.cs" Inherits="WeiXinPF.Web.admin.ucard.user_score" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="user_list.aspx?id=<%=sid %>" class="home"><span>会员列表</span></a>
            <i class="arrow"></i>
            <span>会员积分详情</span>
        </div>
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr class="td_c">
                        ...
                        <td>[<%# Eval("moduleType") %>]<%# Eval("moduleActionName")%>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>

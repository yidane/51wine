...
namespace WeiXinPF.Web.shopmgr.product
{
    public partial class productOnSale : Web.UI.ManagePage
    {
        ...
        private void RptBind(int _category_id, string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("productOnSale.aspx", "category_id={0}&keywords={1}&page={2}", _category_id.ToString(), this.keywords, "__id__");
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("productOnSale_list_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("productOnSale.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("productOnSale_page_size", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("productOnSale.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("productOnSale.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), this.keywords), "Success");
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("productOnSale.aspx", "category_id={0}&keywords={1}", ddlCategoryId.SelectedValue, this.keywords));
        }

...
namespace WeiXinPF.Web.shopmgr.product
{
    public partial class product_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            WeiXinPF.Model.wx_shop_product model = spBll.GetModel(id);
          //  model.wid = wid;
            ...
            WeiXinPF.BLL.wx_shop_product bll = new WeiXinPF.BLL.wx_shop_product();
            bll.Update(model);
                ...
                { //客户可选规格,SKU
                    ...
                    else
                    {
                        ...
                        if (attrvalueArr != null && attrvalueArr.Length > 0)
                        {
                            ...
                            attrStr.Append(" <table class=\"ltable tb_sku\">  <thead> <tr> <th width=\"80\"> 使用 </th> <th> 名称  </th> <th width=\"120\" style=\"display:none;\">  属性加价格 </th> </tr></thead>");
                            ...
                            for (int j = 0; j < attrvalueArr.Length; j++)
                            {
                                ...
                                if (isProductSku)
                                {
                                    ...
                                    if (tmpPrice != "")
                                    {
                                        ...
                                        attrStr.Append("<td style=\"display:none;\">");

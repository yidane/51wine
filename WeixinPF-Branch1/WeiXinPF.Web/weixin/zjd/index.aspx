<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeiXinPF.Web.weixin.zjd.index" %>
...
<head id="head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="css/main.css?v=20150825" media="all">
...
<body onselectstart="return true;" ondragstart="return false;">
    ...
    <div class="body pb_10">
        <div style="position: absolute; left: 10px; top: 10px; z-index: 350;">
            ...
            <audio id="audio" loop="" src="<%=backmusic %>" style="pointer-events: none; display: none; width: 0!important; height: 0!important;"></audio>
            <!-- 上面一行不能换行-->
        </div>
